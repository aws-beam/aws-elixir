...
defmodule AWS.Glue do
  ...
  ## Example:
      ...
      batch_get_data_quality_ruleset_evaluation_run_request() :: %{
        required("RunIds") => list(String.t() | atom())
      }
      
  """
  @type batch_get_data_quality_ruleset_evaluation_run_request() :: %{
          (String.t() | atom()) => any()
        }
  ...
  ## Example:
      ...
      batch_get_data_quality_ruleset_evaluation_run_response() :: %{
        ...
        "RunsNotFound" => list(String.t() | atom())
      }
      
  """
  @type batch_get_data_quality_ruleset_evaluation_run_response() :: %{
          (String.t() | atom()) => any()
        }
  ...
  ## Example:
      ...
      between_configuration() :: %{
        "HighBoundKey" => [String.t() | atom()],
        "LowBoundKey" => [String.t() | atom()],
        "Template" => [String.t() | atom()]
      }
      
  """
  @type between_configuration() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type catalog_table_config_options() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type data_quality_rule_recommendation_run_additional_run_options() :: %{
          (String.t() | atom()) => any()
        }
  ...
  """
  @type data_quality_rule_results_options() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type data_quality_ruleset_evaluation_run() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      distribution_data() :: %{
        "BinEdges" => list(String.t() | atom()),
        "Count" => list(integer()),
        "DataType" => String.t() | atom()
      }
      
  """
  @type distribution_data() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type distribution_results_options() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type export_encryption_configuration() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      field_definition() :: %{
        ...
        "IsQueryable" => boolean(),
        "Name" => [String.t() | atom()],
        "ResponseDateFormat" => [String.t() | atom()]
      }
  ...
  """
  @type filter_overrides() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      filter_string_configuration() :: %{
        "QueryParameterName" => [String.t() | atom()],
        "QuoteCharacter" => [String.t() | atom()],
        "QuoteStringValues" => boolean()
      }
      
  """
  @type filter_string_configuration() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_data_catalog_export_configuration_input() :: %{}
  ...
  """
  @type get_data_catalog_export_configuration_output() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type observation_results_options() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type profiling_results_options() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      put_data_catalog_export_configuration_input() :: %{
        optional("ClientToken") => String.t() | atom(),
        optional("EncryptionConfiguration") => export_encryption_configuration(),
        required("ExportSetting") => list(any())
      }
      
  """
  @type put_data_catalog_export_configuration_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type put_data_catalog_export_configuration_output() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type row_level_results_options() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      start_data_quality_rule_recommendation_run_request() :: %{
        optional("AdditionalRunOptions") => data_quality_rule_recommendation_run_additional_run_options(),
        optional("ClientToken") => String.t() | atom(),
  ...
  @type batch_delete_connection_errors() ::
          operation_timeout_exception() | internal_service_exception()
  ...
  @type batch_get_blueprints_errors() ::
          operation_timeout_exception() | invalid_input_exception() | internal_service_exception()

  @type batch_get_crawlers_errors() :: operation_timeout_exception() | invalid_input_exception()
  ...
  @type create_classifier_errors() ::
          operation_timeout_exception() | invalid_input_exception() | already_exists_exception()
  ...
  @type delete_column_statistics_task_settings_errors() ::
          operation_timeout_exception() | invalid_input_exception() | entity_not_found_exception()
  ...
  @type list_connection_types_errors() :: internal_service_exception() | access_denied_exception()
  ...
  @type list_materialized_view_refresh_task_runs_errors() ::
          operation_timeout_exception() | invalid_input_exception() | access_denied_exception()
  ...
  @type query_schema_version_metadata_errors() ::
          invalid_input_exception() | entity_not_found_exception() | access_denied_exception()
  ...
  """
  @spec batch_get_data_quality_ruleset_evaluation_run(
          map(),
          batch_get_data_quality_ruleset_evaluation_run_request(),
          list()
        ) ::
          {:ok, batch_get_data_quality_ruleset_evaluation_run_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, batch_get_data_quality_ruleset_evaluation_run_errors()}
  def batch_get_data_quality_ruleset_evaluation_run(%Client{} = client, input, options \\ []) do
    meta =
      metadata()

    Request.request_post(client, meta, "BatchGetDataQualityRulesetEvaluationRun", input, options)
  end
  ...
  The export configuration controls whether catalog metadata is exported to S3
  Tables.
  """
  @spec get_data_catalog_export_configuration(
          map(),
          get_data_catalog_export_configuration_input(),
          list()
        ) ::
          {:ok, get_data_catalog_export_configuration_output(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, get_data_catalog_export_configuration_errors()}
  def get_data_catalog_export_configuration(%Client{} = client, input, options \\ []) do
    meta =
      metadata()

    Request.request_post(client, meta, "GetDataCatalogExportConfiguration", input, options)
  end
  ...
  Use this operation to enable or disable the export of catalog metadata to S3
  Tables.
  """
  @spec put_data_catalog_export_configuration(
          map(),
          put_data_catalog_export_configuration_input(),
          list()
        ) ::
          {:ok, put_data_catalog_export_configuration_output(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, put_data_catalog_export_configuration_errors()}
  def put_data_catalog_export_configuration(%Client{} = client, input, options \\ []) do
    meta =
      metadata()

    Request.request_post(client, meta, "PutDataCatalogExportConfiguration", input, options)
  end
