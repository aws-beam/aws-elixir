...
defmodule AWS.IAM do
  ...
  calls to IAM. The Amazon Web Services
  SDKs consist of libraries and sample code for various programming languages and
  platforms
  (for example, Java, Ruby, .NET, iOS, and Android). The SDKs provide a convenient
  way to
  create programmatic access to IAM and Amazon Web Services. For example, the SDKs
  take care of tasks such as
  cryptographically signing requests, managing errors, and retrying requests
  automatically.
  For more information, see [Tools to build on Amazon Web Services](http://aws.amazon.com/tools/).

  Alternatively, you can also use the IAM Query API to make direct calls to the
  IAM
  service. For more information about calling the IAM Query API, see [Making query requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/IAM_UsingQueryAPI.html)
  in the *Identity and Access Management User Guide*. IAM supports GET and
  POST requests for all actions. That is, the API does not require you to use GET
  for some
  ...
  strongly
  recommend that you do not use your Amazon Web Services account access key ID and
  secret access key for
  everyday work with IAM. You can use the access key ID and secret access key for
  an
  IAM user or you can use the Security Token Service to generate temporary
  ...
  you have an
  existing application that uses Signature Version 2, you do not have to update it
  to use
  ...
  """
  @type delete_group_policy_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type delete_open_id_connect_provider_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type entity_info() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_organizations_access_report_response() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type inline_policy_identifier_type() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_attached_group_policies_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_entities_for_policy_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type managed_policy_detail() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      ordered_organization_policy_type() :: %{
        "ServiceControlPolicyInputList" => list(String.t() | atom())
      }
      
  """
  @type ordered_organization_policy_type() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type resource_specific_result() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      server_certificate_metadata() :: %{
        ...
        "Path" => String.t() | atom(),
        "ServerCertificateId" => String.t() | atom(),
        "ServerCertificateName" => String.t() | atom(),
        "UploadDate" => non_neg_integer()
      }
      
  """
  @type server_certificate_metadata() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      simulate_custom_policy_request() :: %{
        optional("CallerArn") => String.t() | atom(),
        optional("ContextEntries") => list(context_entry()),
        optional("Marker") => String.t() | atom(),
        optional("MaxItems") => integer(),
        optional("OrderedOrganizationPolicyInputList") => list(ordered_organization_policy_type()),
        optional("PermissionsBoundaryPolicyInputList") => list(String.t() | atom()),
        optional("ResourceArns") => list(String.t() | atom()),
        optional("ResourceHandlingOption") => String.t() | atom(),
        optional("ResourceOwner") => String.t() | atom(),
        optional("ResourcePolicy") => String.t() | atom(),
        required("ActionNames") => list(String.t() | atom()),
        required("PolicyInputList") => list(String.t() | atom())
      }
      
  """
  @type simulate_custom_policy_request() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      simulate_principal_policy_request() :: %{
        ...
        optional("MaxItems") => integer(),
        optional("PermissionsBoundaryPolicyInputList") => list(String.t() | atom()),
        optional("PolicyExclusionList") => list(list()),
        optional("PolicyInputList") => list(String.t() | atom()),
        optional("ResourceArns") => list(String.t() | atom()),
        optional("ResourceHandlingOption") => String.t() | atom(),
        optional("ResourceOwner") => String.t() | atom(),
  ...
  """
  @type simulate_principal_policy_request() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      update_group_request() :: %{
        optional("NewGroupName") => String.t() | atom(),
  ...
  @type generate_credential_report_errors() ::
          service_failure_exception() | limit_exceeded_exception()
  ...
  *IAM User Guide*.
  ...
  [ResetServiceSpecificCredential](https://docs.aws.amazon.com/IAM/latest/APIReference/API_ResetServiceSpecificCredential.html).   For more information about using service-specific credentials to authenticate to
  an
  Amazon Web Services service, refer to the following docs:

    *
  For service-specific credentials with CodeCommit, refer to [IAM credentials for
  CodeCommit: Git credentials, SSH keys, and Amazon Web Services access
  ...
  refer to [Use IAM with Amazon Keyspaces (for Apache
  Cassandra)](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_keyspaces.html)
  in the
  *IAM User Guide*.
  ...
  **Note:** This operation discloses information about the
  ...
  referenced by service control policies (SCPs). Only context keys referenced by
  the
  ...
  *IAM User Guide*.
  ...
  simulator results can differ from your live Amazon Web Services environment. We
  recommend that you check your policies
