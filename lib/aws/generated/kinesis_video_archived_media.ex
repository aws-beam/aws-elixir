...
defmodule AWS.KinesisVideoArchivedMedia do
  ...
  @spec get_clip(map(), get_clip_input(), list()) ::
          ...
          | {:error, invalid_codec_private_data_exception()}
          | {:error, invalid_media_frame_exception()}
          | {:error, missing_codec_private_data_exception()}
          | {:error, no_data_retention_exception()}
          | {:error, not_authorized_exception()}
          | {:error, resource_not_found_exception()}
          | {:error, unsupported_stream_media_type_exception()}
