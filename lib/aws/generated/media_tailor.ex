...
defmodule AWS.MediaTailor do
  ...
  """
  @type ads_personalization_concurrency() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type ads_personalization_timeouts() :: %{(String.t() | atom()) => any()}
  ...
  @spec create_program(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def create_program(%Client{} = client, program_name, channel_name, input, options \\ []) do
    url_path =
  ...
  @spec delete_program(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def delete_program(%Client{} = client, program_name, channel_name, input, options \\ []) do
    url_path =
      "/channel/#{AWS.Util.encode_uri(channel_name)}/program/#{AWS.Util.encode_uri(program_name)}"
  ...
  @spec describe_program(map(), String.t() | atom(), String.t() | atom(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def describe_program(%Client{} = client, program_name, channel_name, options \\ []) do
    url_path =
      "/channel/#{AWS.Util.encode_uri(channel_name)}/program/#{AWS.Util.encode_uri(program_name)}"
  ...
  @spec get_prefetch_schedule(map(), String.t() | atom(), String.t() | atom(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_prefetch_schedule(%Client{} = client, playback_configuration_name, name, options \\ []) do
    url_path =
      "/prefetchSchedule/#{AWS.Util.encode_uri(playback_configuration_name)}/#{AWS.Util.encode_uri(name)}"
  ...
  @spec list_functions(map(), String.t() | atom() | nil, String.t() | atom() | nil, list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def list_functions(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
    url_path = "/functions"
    headers = []
    query_params = []
  ...
  @spec update_program(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def update_program(%Client{} = client, program_name, channel_name, input, options \\ []) do
    url_path =
      "/channel/#{AWS.Util.encode_uri(channel_name)}/program/#{AWS.Util.encode_uri(program_name)}"
