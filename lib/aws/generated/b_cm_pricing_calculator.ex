...
defmodule AWS.BCMPricingCalculator do
  ...
  @type batch_create_bill_scenario_commitment_modification_errors() ::
          resource_not_found_exception() | data_unavailable_exception() | conflict_exception()
  ...
  @type create_bill_scenario_errors() ::
          service_quota_exceeded_exception() | data_unavailable_exception() | conflict_exception()
