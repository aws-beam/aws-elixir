  ...
  *Security Hub CSPM User Guide*
  ...
  ## Example:
      ...
      describe_standards_request() :: %{
        optional("MaxResults") => integer(),
        optional("NextToken") => String.t() | atom(),
        optional("Providers") => list(list(any())())
      }
  ...
  """
  @type delete_connector_v2_response() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      resource_owner() :: %{
        "Account" => resource_owner_account(),
        "Org" => resource_owner_org()
      }

  """
  @type resource_owner() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      disable_security_hub_feature_v2_response() :: %{}

  """
  @type disable_security_hub_feature_v2_response() :: %{}
  ...
  ## Example:
      ...
      a_idetails() :: %{
        "CanonicalId" => String.t() | atom(),
        "HostResourceGuid" => String.t() | atom(),
        "HostResourceType" => String.t() | atom(),
        "SelfHostedAIAgentFrameworkResourceCount" => integer(),
        "SelfHostedAIAgentResourceCount" => integer(),
        "SelfHostedAIAgentToolsAndIdentityResourceCount" => integer(),
        "SelfHostedAIDevelopmentResourceCount" => integer(),
        "SelfHostedAIExternalEndpointResourceCount" => integer(),
        "SelfHostedAIModelResourceCount" => integer(),
        "SelfHostedAIModelServingResourceCount" => integer(),
        "SelfHostedTotalAIResourceCount" => integer()
      }

  """
  @type a_idetails() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type resource_owner_account() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      aws_security_finding_filters() :: %{
        ...
        "ResourceOwnerOrgId" => list(string_filter()),
        ...
        "ResourceOwnerAccountId" => list(string_filter()),
        ...
        "ResourceProvider" => list(string_filter()),
  ...
  """
  @type resource_owner_org() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      azure_update_configuration() :: %{
        "AzureRegions" => list(String.t() | atom()),
        "ScopeConfiguration" => azure_scope_configuration()
      }

  """
  @type azure_update_configuration() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      azure_scope_configuration() :: %{
        "ScopeType" => list(any()),
        "ScopeValues" => list(String.t() | atom())
      }

  """
  @type azure_scope_configuration() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      azure_provider_configuration() :: %{
        "AWSConfigConnectorArn" => String.t() | atom(),
        "AzureRegions" => list(String.t() | atom()),
        "ScopeConfiguration" => azure_scope_configuration()
      }

  """
  @type azure_provider_configuration() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      feature_detail() :: %{
        "FeatureStatus" => list(any()),
        "UpdatedAt" => non_neg_integer()
      }

  """
  @type feature_detail() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type azure_detail() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      get_connector_v2_response() :: %{
        ...
        "Description" => String.t() | atom(),
        "EnablementStatus" => list(any()),
        "EnablementStatusReason" => String.t() | atom(),
        "Health" => health_check(),
        "KmsKeyArn" => String.t() | atom(),
        "LastUpdatedAt" => non_neg_integer(),
        "Name" => String.t() | atom(),
  ...
  """
  @type securityhub_record() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      list_connectors_request() :: %{
        ...
        optional("EnablementStatus") => list(any()),
        optional("MaxResults") => integer(),
        optional("NextToken") => String.t() | atom(),
  ...
  ## Example:
      ...
      cspm_connector_summary() :: %{
        ...
        "EnablementStatus" => list(any()),
        "Name" => String.t() | atom(),
        "ProviderSummary" => cspm_provider_summary()
      }

  """
  @type cspm_connector_summary() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type cspm_provider_summary() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type health_issue() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      enable_security_hub_feature_v2_response() :: %{}

  """
  @type enable_security_hub_feature_v2_response() :: %{}
  ...
  ## Example:
      ...
      cspm_health_check() :: %{
        "ConnectorStatus" => list(any()),
        "Issues" => list(health_issue()),
        "LastCheckedAt" => non_neg_integer(),
        "Message" => String.t() | atom()
      }

  """
  @type cspm_health_check() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      enable_security_hub_feature_v2_request() :: %{}

  """
  @type enable_security_hub_feature_v2_request() :: %{}
  ...
  ## Example:
      ...
      resource_result() :: %{
        ...
        "ResourceCloudPartition" => String.t() | atom(),
        "ResourceConfig" => any(),
        ...
        "ResourceProvider" => String.t() | atom(),
        "ResourceRegion" => String.t() | atom(),
        "ResourceSubCategory" => list(any()),
  ...
  """
  @type update_connector_v2_response() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      disable_security_hub_feature_v2_request() :: %{}

  """
  @type disable_security_hub_feature_v2_request() :: %{}
  ...
  ## Example:
      ...
      list_connectors_response() :: %{
        "Connectors" => list(cspm_connector_summary()),
        "NextToken" => String.t() | atom()
      }
  ...
  @type describe_standards_errors() ::
          internal_exception() | invalid_access_exception() | invalid_input_exception()
  ...
  @type disable_security_hub_feature_v2_errors() ::
          access_denied_exception()
          | resource_not_found_exception()
          | validation_exception()
          | internal_server_exception()
  ...
  @type enable_security_hub_feature_v2_errors() ::
          access_denied_exception()
          | resource_not_found_exception()
          | validation_exception()
          | internal_server_exception()
  ...
  @type list_enabled_products_for_import_errors() ::
          internal_exception() | invalid_access_exception() | limit_exceeded_exception()
  ...
  @type list_tags_for_resource_errors() ::
          resource_not_found_exception() | internal_exception() | invalid_input_exception()
  ...
  A connector establishes a connection between Security Hub CSPM and a third-party
  ...
  When you delete a connector, Security Hub CSPM stops ingesting findings and
  resource data from the connected cloud provider environment.
  """
  ...
  def delete_connector(%Client{} = client, connector_id, input, options \\ []) do
    url_path = "/connectors/#{AWS.Util.encode_multi_segment_uri(connector_id)}"
    headers = []
    custom_headers = []
    query_params = []
  ...
  def describe_standards(
    ...
    query_params =
      if !is_nil(providers) do
        [{"Providers", providers} | query_params]
      else
        query_params
      end
  ...
  The operation is idempotent. If the feature is already disabled, no changes are
  made. You cannot disable a feature that is managed by an organization policy.
  """
  @spec disable_security_hub_feature_v2(
          map(),
          String.t() | atom(),
          disable_security_hub_feature_v2_request(),
          list()
        ) ::
          {:ok, disable_security_hub_feature_v2_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, disable_security_hub_feature_v2_errors()}
  def disable_security_hub_feature_v2(%Client{} = client, feature_name, input, options \\ []) do
    url_path = "/hubv2/feature/#{AWS.Util.encode_uri(feature_name)}"
    headers = []
    custom_headers = []
    query_params = []
  ...
  Disabling the service also disables all opt-in features that are currently
  ...
  The service must be enabled before you can enable a feature. The operation is
  idempotent. If the feature is already enabled, no changes are made. You cannot
  enable a feature that is managed by an organization policy.
  """
  @spec enable_security_hub_feature_v2(
          map(),
          String.t() | atom(),
          enable_security_hub_feature_v2_request(),
          list()
        ) ::
          {:ok, enable_security_hub_feature_v2_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, enable_security_hub_feature_v2_errors()}
  def enable_security_hub_feature_v2(%Client{} = client, feature_name, input, options \\ []) do
    url_path = "/hubv2/feature/#{AWS.Util.encode_uri(feature_name)}"
    headers = []
    custom_headers = []
    query_params = []
  ...
  def get_connector(%Client{} = client, connector_id, options \\ []) do
    url_path = "/connectors/#{AWS.Util.encode_multi_segment_uri(connector_id)}"
    headers = []
    query_params = []
  ...
  `ResourceType` with the `SelfHosted::AI::` prefix, such as
  ...
  def list_connectors(
    ...
    query_params =
      if !is_nil(enablement_status) do
        [{"EnablementStatus", enablement_status} | query_params]
      else
        query_params
      end
  ...
  def list_invitations(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
  ...
  def update_connector(%Client{} = client, connector_id, input, options \\ []) do
    url_path = "/connectors/#{AWS.Util.encode_multi_segment_uri(connector_id)}"
    headers = []
    custom_headers = []
    query_params = []
