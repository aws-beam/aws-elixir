...
defmodule AWS.CleanRoomsML do
  ...
  @type create_training_dataset_errors() ::
          conflict_exception() | access_denied_exception() | validation_exception()
  ...
  @type list_audience_export_jobs_errors() :: access_denied_exception() | validation_exception()

  @type list_audience_generation_jobs_errors() ::
          access_denied_exception() | validation_exception()

  @type list_audience_models_errors() :: access_denied_exception() | validation_exception()

  @type list_collaboration_configured_model_algorithm_associations_errors() ::
          access_denied_exception() | throttling_exception() | validation_exception()
  ...
  @type list_training_datasets_errors() :: access_denied_exception() | validation_exception()
