...
defmodule AWS.EFS do
  ...
  quick succession, and the file system is near the limit of 1,000 access points,
  ...
  `elasticfilesystem:TagResource` action. For more information, see [Granting permissions to tag resources during
