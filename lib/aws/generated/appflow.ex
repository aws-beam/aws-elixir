...
defmodule AWS.Appflow do
  ...
  *Authorize Apps with OAuth*
  ...
  """
  @type honeycode_connector_profile_properties() :: %{String.t() => any()}
  ...
  """
  @type lookout_metrics_destination_properties() :: %{String.t() => any()}
  ...
  """
  @type trendmicro_connector_profile_properties() :: %{String.t() => any()}
  ...
  """
  @type reset_connector_metadata_cache_response() :: %{String.t() => any()}
  ...
  """
  @type amplitude_metadata() :: %{String.t() => any()}
  ...
  """
  @type google_analytics_connector_profile_properties() :: %{String.t() => any()}
  ...
  """
  @type marketo_metadata() :: %{String.t() => any()}
  ...
  """
  @type amplitude_connector_profile_properties() :: %{String.t() => any()}
  ...
  """
  @type s_a_p_o_data_metadata() :: %{String.t() => any()}
  ...
  """
  @type unregister_connector_response() :: %{String.t() => any()}
  ...
  """
  @type customer_profiles_metadata() :: %{String.t() => any()}
  ...
  """
  @type trendmicro_metadata() :: %{String.t() => any()}
  ...
  """
  @type infor_nexus_metadata() :: %{String.t() => any()}
  ...
  """
  @type upsolver_metadata() :: %{String.t() => any()}
  ...
  """
  @type singular_metadata() :: %{String.t() => any()}
  ...
  """
  @type pardot_metadata() :: %{String.t() => any()}
  ...
  """
  @type singular_connector_profile_properties() :: %{String.t() => any()}
  ...
  """
  @type dynatrace_metadata() :: %{String.t() => any()}
  ...
  """
  @type event_bridge_metadata() :: %{String.t() => any()}
  ...
  """
  @type veeva_metadata() :: %{String.t() => any()}
  ...
  """
  @type service_now_metadata() :: %{String.t() => any()}
  ...
  """
  @type delete_connector_profile_response() :: %{String.t() => any()}
  ...
  """
  @type datadog_metadata() :: %{String.t() => any()}
  ...
  @spec create_connector_profile(map(), create_connector_profile_request(), list()) ::
          ...
          | {:error, connector_authentication_exception()}
          | {:error, internal_server_exception()}
  ...
  @spec create_flow(map(), create_flow_request(), list()) ::
          ...
          | {:error, conflict_exception()}
          | {:error, connector_authentication_exception()}
          | {:error, connector_server_exception()}
          | {:error, internal_server_exception()}
          | {:error, resource_not_found_exception()}
          | {:error, service_quota_exceeded_exception()}
          | {:error, validation_exception()}
