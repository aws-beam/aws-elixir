...
defmodule AWS.IoTJobsDataPlane do
  ...
  *iot-jobs-data*.
  ...
  """
  @type get_pending_job_executions_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type job_execution_state() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      start_command_execution_request() :: %{
        ...
        required("commandArn") => String.t() | Atom.t(),
        required("targetArn") => String.t() | Atom.t()
      }

  """
  @type start_command_execution_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_command_execution_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_next_pending_job_execution_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_next_pending_job_execution_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type terminal_state_exception() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type update_job_execution_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type update_job_execution_response() :: %{String.t() | Atom.t() => any()}
  ...
  action.
  """
  @spec get_pending_job_executions(map(), String.t() | Atom.t(), list()) ::
