...
defmodule AWS.Resiliencehubv2 do
  ...
  def get_failure_mode_finding(%Client{} = client, service_arn, finding_id, options \\ []) do
  ...
  def get_user_journey(%Client{} = client, user_journey_id, system_arn, options \\ []) do
  ...
  def list_policies(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
