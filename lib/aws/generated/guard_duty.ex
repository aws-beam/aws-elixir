...
defmodule AWS.GuardDuty do
  ...
  *.
  ...
  @type create_investigation_errors() ::
          bad_request_exception() | access_denied_exception() | internal_server_error_exception()
  ...
  @type start_malware_scan_errors() ::
          bad_request_exception() | conflict_exception() | internal_server_error_exception()
  ...
  def delete_filter(%Client{} = client, filter_name, detector_id, input, options \\ []) do
    url_path =
  ...
  def delete_ip_set(%Client{} = client, ip_set_id, detector_id, input, options \\ []) do
    url_path =
  ...
  def get_filter(%Client{} = client, filter_name, detector_id, options \\ []) do
    url_path =
      "/detector/#{AWS.Util.encode_uri(detector_id)}/filter/#{AWS.Util.encode_uri(filter_name)}"
  ...
  def get_investigation(%Client{} = client, investigation_id, detector_id, options \\ []) do
    url_path =
  ...
  def get_ip_set(%Client{} = client, ip_set_id, detector_id, options \\ []) do
    url_path =
      "/detector/#{AWS.Util.encode_uri(detector_id)}/ipset/#{AWS.Util.encode_uri(ip_set_id)}"
  ...
  def get_threat_entity_set(%Client{} = client, threat_entity_set_id, detector_id, options \\ []) do
    url_path =
      "/detector/#{AWS.Util.encode_uri(detector_id)}/threatentityset/#{AWS.Util.encode_uri(threat_entity_set_id)}"
  ...
  def get_threat_intel_set(%Client{} = client, threat_intel_set_id, detector_id, options \\ []) do
    url_path =
      "/detector/#{AWS.Util.encode_uri(detector_id)}/threatintelset/#{AWS.Util.encode_uri(threat_intel_set_id)}"
  ...
  def list_detectors(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
    url_path = "/detector"
    headers = []
    query_params = []
  ...
  def update_filter(%Client{} = client, filter_name, detector_id, input, options \\ []) do
    url_path =
      "/detector/#{AWS.Util.encode_uri(detector_id)}/filter/#{AWS.Util.encode_uri(filter_name)}"
  ...
  def update_ip_set(%Client{} = client, ip_set_id, detector_id, input, options \\ []) do
    url_path =
      "/detector/#{AWS.Util.encode_uri(detector_id)}/ipset/#{AWS.Util.encode_uri(ip_set_id)}"
