...
defmodule AWS.CloudFront do
  ...
  @type create_public_key_errors() ::
          public_key_already_exists() | invalid_argument() | too_many_public_keys()
  ...
  @type describe_connection_function_errors() ::
          unsupported_operation() | entity_not_found() | invalid_argument() | access_denied()
  ...
  @type get_cache_policy_errors() :: access_denied() | no_such_cache_policy()

  @type get_cache_policy_config_errors() :: access_denied() | no_such_cache_policy()
  ...
  @type get_connection_function_errors() ::
          unsupported_operation() | entity_not_found() | access_denied()
  ...
  @type get_distribution_errors() :: access_denied() | no_such_distribution()

  @type get_distribution_config_errors() :: access_denied() | no_such_distribution()
  ...
  @type get_invalidation_errors() ::
          no_such_invalidation() | access_denied() | no_such_distribution()
  ...
  @type get_realtime_log_config_errors() ::
          invalid_argument() | access_denied() | no_such_realtime_log_config()
  ...
  @type get_streaming_distribution_errors() :: access_denied() | no_such_streaming_distribution()

  @type get_streaming_distribution_config_errors() ::
          access_denied() | no_such_streaming_distribution()

  @type get_trust_store_errors() :: entity_not_found() | invalid_argument() | access_denied()
  ...
  @type list_cache_policies_errors() ::
          invalid_argument() | access_denied() | no_such_cache_policy()

  @type list_cloud_front_origin_access_identities_errors() :: invalid_argument()

  @type list_conflicting_aliases_errors() :: invalid_argument() | no_such_distribution()
  ...
  @type list_connection_groups_errors() ::
          entity_not_found() | invalid_argument() | access_denied()

  @type list_continuous_deployment_policies_errors() ::
          invalid_argument() | no_such_continuous_deployment_policy() | access_denied()
  ...
  @type list_distributions_by_key_group_errors() :: invalid_argument() | no_such_resource()
  ...
  @type list_distributions_by_web_acl_id_errors() :: invalid_argument() | invalid_web_acl_id()
  ...
  @type list_invalidations_errors() ::
          invalid_argument() | access_denied() | no_such_distribution()
  ...
  @type list_tags_for_resource_errors() ::
          invalid_argument() | access_denied() | invalid_tagging() | no_such_resource()

  @type list_trust_stores_errors() :: entity_not_found() | invalid_argument() | access_denied()
  ...
  **To delete an RTMP distribution using the CloudFront API**:
  ...
  def get_connection_function(%Client{} = client, identifier, stage \\ nil, options \\ []) do
    ...
    options =
      Keyword.put(
        options,
        :response_header_parameters,
        [{"ETag", "ETag"}, {"Content-Type", "ContentType"}]
      )
  ...
  def get_invalidation(%Client{} = client, id, distribution_id, options \\ []) do
    url_path =
  ...
  def list_anycast_ip_lists(%Client{} = client, max_items \\ nil, marker \\ nil, options \\ []) do
    url_path = "/2020-05-31/anycast-ip-list"
    headers = []
    query_params = []
  ...
  def list_distributions(%Client{} = client, max_items \\ nil, marker \\ nil, options \\ []) do
    url_path = "/2020-05-31/distribution"
    headers = []
    query_params = []
  ...
  def list_key_groups(%Client{} = client, max_items \\ nil, marker \\ nil, options \\ []) do
    url_path = "/2020-05-31/key-group"
    headers = []
    query_params = []
  ...
  def list_public_keys(%Client{} = client, max_items \\ nil, marker \\ nil, options \\ []) do
    url_path = "/2020-05-31/public-key"
    headers = []
    query_params = []
  ...
  def list_vpc_origins(%Client{} = client, max_items \\ nil, marker \\ nil, options \\ []) do
    url_path = "/2020-05-31/vpc-origin"
    headers = []
    query_params = []
