...
defmodule AWS.DynamoDB do
  ...
  ## Example:
      ...
      create_table_input() :: %{
        ...
        optional("VectorIndexes") => list(vector_index()),
  ...
  """
  @type create_vector_index_action() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type delete_vector_index_action() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      restore_table_from_backup_input() :: %{
        ...
        optional("VectorIndexOverride") => list(vector_index()),
        required("BackupArn") => String.t() | atom(),
  ...
  """
  @type search_schema_element() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      search_vectors_input() :: %{
        ...
        optional("ProjectionExpression") => String.t() | atom(),
        optional("ReturnConsumedCapacity") => list(any()),
        optional("SearchConditionExpression") => String.t() | atom(),
        required("IndexName") => String.t() | atom(),
        required("SearchVector") => list(list()),
        required("TableName") => String.t() | atom(),
        required("TopK") => integer()
      }
      
  """
  @type search_vectors_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type search_vectors_output() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      update_table_input() :: %{
        ...
        optional("StreamSpecification") => stream_specification(),
        optional("TableClass") => list(any()),
        optional("VectorIndexUpdates") => list(vector_index_update()),
        optional("WarmThroughput") => warm_throughput(),
        required("TableName") => String.t() | atom()
      }
  ...
  """
  @type vector_attribute_definition() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type vector_capacity() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type vector_index() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type vector_index_description() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type vector_index_info() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type vector_index_update() :: %{(String.t() | atom()) => any()}
  ...
  *eventually consistent*
  ...
  """
  @spec search_vectors(map(), search_vectors_input(), list()) ::
          {:ok, search_vectors_output(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, search_vectors_errors()}
  def search_vectors(%Client{} = client, input, options \\ []) do
    meta =
      metadata()

    Request.request_post(client, meta, "SearchVectors", input, options)
  end
