...
defmodule AWS.AuditManager do
  ...
  """
  @type get_settings_request() :: %{String.t() => any()}
  ...
  """
  @type delete_control_response() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_framework_response() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_framework_request() :: %{String.t() => any()}
  ...
  """
  @type deregister_account_request() :: %{String.t() => any()}
  ...
  """
  @type deregister_organization_admin_account_response() :: %{String.t() => any()}
  ...
  """
  @type get_assessment_framework_request() :: %{String.t() => any()}
  ...
  """
  @type get_insights_by_assessment_request() :: %{String.t() => any()}
  ...
  """
  @type get_evidence_folder_request() :: %{String.t() => any()}
  ...
  """
  @type get_organization_admin_account_request() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_report_request() :: %{String.t() => any()}
  ...
  """
  @type associate_assessment_report_evidence_folder_response() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_response() :: %{String.t() => any()}
  ...
  """
  @type get_assessment_request() :: %{String.t() => any()}
  ...
  """
  @type disassociate_assessment_report_evidence_folder_response() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_framework_share_response() :: %{String.t() => any()}
  ...
  """
  @type delete_control_request() :: %{String.t() => any()}
  ...
  """
  @type get_evidence_request() :: %{String.t() => any()}
  ...
  """
  @type get_assessment_report_url_request() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_request() :: %{String.t() => any()}
  ...
  """
  @type get_services_in_scope_request() :: %{String.t() => any()}
  ...
  """
  @type delete_assessment_report_response() :: %{String.t() => any()}
  ...
  """
  @type get_account_status_request() :: %{String.t() => any()}
