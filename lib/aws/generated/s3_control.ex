...
defmodule AWS.S3Control do
  ...
  ## Example:
      ...
      s3_copy_object_operation() :: %{
        ...
        "RedirectLocation" => String.t() | atom(),
        "RequesterPays" => boolean(),
        "SSEAwsKmsKeyId" => String.t() | atom(),
        "StorageClass" => list(any()),
        "TargetKeyPrefix" => String.t() | atom(),
        "TargetResource" => String.t() | atom(),
        "UnModifiedSinceConstraint" => non_neg_integer()
      }

  """
  @type s3_copy_object_operation() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type create_access_point_for_object_lambda_result() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      access_grants_location_configuration() :: %{
        "S3SubPrefix" => String.t() | atom()
      }

  """
  @type access_grants_location_configuration() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type s3_set_object_legal_hold_operation() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type job_failure() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type include() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_caller_access_grants_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type update_access_grants_location_result() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_access_point_scope_result() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      job_descriptor() :: %{
        ...
        "SuspendedCause" => String.t() | atom(),
        "SuspendedDate" => non_neg_integer(),
        "TerminationDate" => non_neg_integer()
      }

  """
  @type job_descriptor() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      create_access_grant_request() :: %{
        ...
        required("AccessGrantsLocationId") => String.t() | atom(),
        required("AccountId") => String.t() | atom(),
        optional("ApplicationArn") => String.t() | atom(),
  ...
  """
  @type create_access_grant_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type job_manifest_generator_filter() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type s3_grant() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type s3_object_owner() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type storage_lens_group_filter() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type create_multi_region_access_point_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type s3_object_metadata() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type storage_lens_group() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_access_point_policy_for_object_lambda_result() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_bucket_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type storage_lens_data_export_encryption() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_access_grants_instance_result() :: %{(String.t() | atom()) => any()}
  ...
  @type delete_job_tagging_errors() ::
          internal_service_exception() | too_many_requests_exception() | not_found_exception()
  ...
  *Amazon S3 User Guide*.
  ...
  account. This
  operation might be restricted when the account is managed by organization-level
  Block
  Public Access policies. You’ll get an Access Denied (403) error when the account
  is managed
  by organization-level Block Public Access policies. Organization-level policies
  override
  ...
  *Amazon S3 User Guide*. For information about S3 replication on Outposts
  ...
  """
  @spec get_bucket_replication(map(), String.t() | atom(), String.t() | atom(), list()) ::
  ...
  """
  @spec get_bucket_tagging(map(), String.t() | atom(), String.t() | atom(), list()) ::
  ...
  [GetBucketLifecycleConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_GetBucketLifecycleConfiguration.html)
  """
  @spec get_bucket_versioning(map(), String.t() | atom(), String.t() | atom(), list()) ::
  ...
  *Amazon S3 User Guide*.
  ...
  account. This
  operation returns the effective account-level configuration, which may inherit
  from
  organization-level policies. For more information, see [ Using Amazon S3 block public
  access](https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html).
  ...
  *Amazon S3 User Guide*.
  ...
  For general purpose buckets, access points for general purpose buckets, Storage
  Lens groups, and S3 Access Grants, you must have the `s3:ListTagsForResource`
  ...
  **Suspended** - Suspends versioning for the objects
  ...
  Amazon Web Services account. This operation may be restricted when the account
  is managed by
  organization-level Block Public Access policies. You might get an Access Denied
  (403) error
  ...
  *Amazon S3 User Guide*.
  ...
  For general purpose buckets, access points for general purpose buckets, Storage
  Lens groups, and S3 Access Grants, you must have the `s3:TagResource` permission
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  For general purpose buckets, access points for general purpose buckets, Storage
  Lens groups, and S3 Access Grants, you must have the `s3:UntagResource`
  permission to use this operation.
