...
defmodule AWS.BCMPricingCalculator do
  ...
  @type batch_create_bill_scenario_commitment_modification_errors() ::
          resource_not_found_exception() | conflict_exception() | data_unavailable_exception()
  ...
  @type create_bill_scenario_errors() ::
          conflict_exception() | service_quota_exceeded_exception() | data_unavailable_exception()

  @type create_workload_estimate_errors() ::
          conflict_exception() | service_quota_exceeded_exception() | data_unavailable_exception()

  @type delete_bill_estimate_errors() :: conflict_exception() | data_unavailable_exception()

  @type delete_bill_scenario_errors() :: conflict_exception() | data_unavailable_exception()

  @type delete_workload_estimate_errors() :: data_unavailable_exception()

  @type get_bill_estimate_errors() ::
          resource_not_found_exception() | data_unavailable_exception()
  ...
  @type update_preferences_errors() ::
          service_quota_exceeded_exception() | data_unavailable_exception()
