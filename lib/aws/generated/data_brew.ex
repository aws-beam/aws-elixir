...
defmodule AWS.DataBrew do
  ...
  """
  @type stop_job_run_request() :: %{String.t() => any()}
  ...
  """
  @type describe_ruleset_request() :: %{String.t() => any()}
  ...
  """
  @type delete_recipe_version_request() :: %{String.t() => any()}
  ...
  """
  @type delete_ruleset_request() :: %{String.t() => any()}
