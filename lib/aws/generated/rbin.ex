...
defmodule AWS.Rbin do
  ...
  """
  @type lock_configuration() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type lock_rule_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type lock_rule_response() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      resource_tag() :: %{
        "ResourceTagKey" => String.t() | Atom.t(),
        "ResourceTagValue" => String.t() | Atom.t()
      }
  ...
  """
  @type unlock_delay() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type unlock_rule_response() :: %{String.t() | Atom.t() => any()}
  ...
  *Amazon EBS User Guide*.
  ...
  """
  @spec delete_rule(map(), String.t() | Atom.t(), delete_rule_request(), list()) ::
  ...
  """
  @spec get_rule(map(), String.t() | Atom.t(), list()) ::
  ...
  have exclusion tags.
  """
  @spec lock_rule(map(), String.t() | Atom.t(), lock_rule_request(), list()) ::
  ...
  """
  @spec unlock_rule(map(), String.t() | Atom.t(), unlock_rule_request(), list()) ::
  ...
  in the *Amazon Elastic Compute Cloud User Guide*.
  """
  @spec update_rule(map(), String.t() | Atom.t(), update_rule_request(), list()) ::
