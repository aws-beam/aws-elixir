...
defmodule AWS.Batch do
  ...
  """
  @type deregister_job_definition_response() :: %{String.t() => any()}
  ...
  """
  @type delete_job_queue_response() :: %{String.t() => any()}
  ...
  """
  @type delete_scheduling_policy_response() :: %{String.t() => any()}
  ...
  """
  @type terminate_job_response() :: %{String.t() => any()}
  ...
  """
  @type update_scheduling_policy_response() :: %{String.t() => any()}
  ...
  """
  @type delete_compute_environment_response() :: %{String.t() => any()}
