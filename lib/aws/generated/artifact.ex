...
defmodule AWS.Artifact do
  ...
  ## Example:
      ...
      put_compliance_inquiry_feedback_request() :: %{
        ...
        optional("queryIdentifier") => [integer()],
        optional("reasonCodes") => list(list(any())()),
        optional("responseRevisionId") => [integer()],
        required("complianceInquiryId") => String.t() | atom(),
        required("rating") => list(any())
      }

  """
  @type put_compliance_inquiry_feedback_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type put_compliance_inquiry_feedback_response() :: %{(String.t() | atom()) => any()}
  ...
  """
  @spec put_compliance_inquiry_feedback(map(), put_compliance_inquiry_feedback_request(), list()) ::
          {:ok, put_compliance_inquiry_feedback_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, put_compliance_inquiry_feedback_errors()}
  def put_compliance_inquiry_feedback(%Client{} = client, input, options \\ []) do
    url_path = "/v1/compliance-inquiry/putFeedback"
    headers = []
    custom_headers = []
    query_params = []
