...
defmodule AWS.Panorama do
  ...
  *AWS Panorama Developer Guide*.
  ...
  """
  @type describe_package_import_job_request() :: %{String.t() => any()}
  ...
  """
  @type describe_node_from_template_job_request() :: %{String.t() => any()}
  ...
  """
  @type describe_application_instance_request() :: %{String.t() => any()}
  ...
  """
  @type register_package_version_response() :: %{String.t() => any()}
  ...
  """
  @type describe_device_job_request() :: %{String.t() => any()}
  ...
  """
  @type describe_application_instance_details_request() :: %{String.t() => any()}
  ...
  """
  @type remove_application_instance_request() :: %{String.t() => any()}
  ...
  """
  @type deregister_package_version_response() :: %{String.t() => any()}
  ...
  """
  @type remove_application_instance_response() :: %{String.t() => any()}
