...
defmodule AWS.ChimeSDKMessaging do
  ...
  """
  @type describe_channel_flow_request() :: %{String.t() => any()}
  ...
  """
  @type delete_channel_flow_request() :: %{String.t() => any()}
  ...
  """
  @type delete_messaging_streaming_configurations_request() :: %{String.t() => any()}
  ...
  """
  @type get_messaging_streaming_configurations_request() :: %{String.t() => any()}
