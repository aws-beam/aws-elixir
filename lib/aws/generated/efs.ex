...
defmodule AWS.EFS do
  ...
  @type create_tags_errors() :: file_system_not_found() | bad_request() | internal_server_error()

  @type delete_access_point_errors() ::
          access_point_not_found() | bad_request() | internal_server_error()

  @type delete_file_system_errors() ::
          file_system_in_use() | file_system_not_found() | bad_request() | internal_server_error()
  ...
  @type delete_tags_errors() :: file_system_not_found() | bad_request() | internal_server_error()
  ...
  @type describe_file_system_policy_errors() ::
          file_system_not_found() | bad_request() | internal_server_error() | policy_not_found()

  @type describe_file_systems_errors() ::
          file_system_not_found() | bad_request() | internal_server_error()
