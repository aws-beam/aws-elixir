...
defmodule AWS.DirectoryServiceData do
  ...
  **Amazon Web Services Account** - Supports a total of 100 TPS for
  ...
  """
  @type list_groups_result() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      user_summary() :: %{
        ...
        "SAMAccountName" => String.t() | Atom.t(),
        "SID" => String.t() | Atom.t(),
  ...
  """
  @type search_users_result() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      list_group_members_request() :: %{
        ...
        optional("MemberRealm") => String.t() | Atom.t(),
        optional("NextToken") => String.t() | Atom.t(),
        optional("Realm") => String.t() | Atom.t(),
        required("DirectoryId") => String.t() | Atom.t(),
        required("SAMAccountName") => String.t() | Atom.t()
      }
  ...
  """
  @type create_user_result() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      describe_user_result() :: %{
        "DirectoryId" => String.t() | Atom.t(),
        "DistinguishedName" => String.t() | Atom.t(),
        ...
        "SID" => String.t() | Atom.t(),
        "Surname" => String.t() | Atom.t(),
        "UserPrincipalName" => String.t() | Atom.t()
      }

  """
  @type describe_user_result() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type search_groups_result() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      search_groups_request() :: %{
        ...
        optional("Realm") => String.t() | Atom.t(),
        required("DirectoryId") => String.t() | Atom.t(),
        required("SearchAttributes") => list(String.t() | Atom.t()),
        required("SearchString") => String.t() | Atom.t()
      }
  ...
  ## Example:
      ...
      remove_group_member_request() :: %{
        ...
        required("MemberName") => String.t() | Atom.t()
      }

  """
  @type remove_group_member_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_group_members_result() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_users_result() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      describe_user_request() :: %{
        optional("OtherAttributes") => list(String.t() | Atom.t()),
        optional("Realm") => String.t() | Atom.t(),
        required("DirectoryId") => String.t() | Atom.t(),
        required("SAMAccountName") => String.t() | Atom.t()
      }
  ...
  """
  @type add_group_member_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_groups_for_member_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_groups_for_member_result() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type describe_group_result() :: %{String.t() | Atom.t() => any()}
