...
defmodule AWS.Kafka do
  ...
  """
  @type channel_logging_info() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type channel_state_info() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type dead_letter_queue_s3() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type partition_source() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type record_converter() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      record_schema() :: %{
        "GsrArn" => String.t() | atom()
      }

  """
  @type record_schema() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type schema_evolution() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type table_creation() :: %{(String.t() | atom()) => any()}
  ...
  @type put_cluster_policy_errors() ::
          internal_server_error_exception() | forbidden_exception() | bad_request_exception()
  ...
  def create_channel(%Client{} = client, cluster_arn, input, options \\ []) do
    url_path = "/v1/clusters/#{AWS.Util.encode_uri(cluster_arn)}/channels"
    headers = []
    custom_headers = []
    query_params = []
  ...
  The channel transitions through DELETING and is removed when the asynchronous
  delete completes.
  """
  @spec delete_channel(
          map(),
  ...
  def delete_channel(%Client{} = client, channel_arn, cluster_arn, input, options \\ []) do
    url_path =
      "/v1/clusters/#{AWS.Util.encode_uri(cluster_arn)}/channels/#{AWS.Util.encode_uri(channel_arn)}"
  ...
  def describe_channel(%Client{} = client, channel_arn, cluster_arn, options \\ []) do
    url_path =
      "/v1/clusters/#{AWS.Util.encode_uri(cluster_arn)}/channels/#{AWS.Util.encode_uri(channel_arn)}"
  ...
  Exactly one of icebergDestinationUpdate or s3DestinationUpdate must be supplied.
  """
  @spec update_channel(
          map(),
          String.t() | atom(),
  ...
  def update_channel(%Client{} = client, channel_arn, cluster_arn, input, options \\ []) do
    url_path =
      "/v1/clusters/#{AWS.Util.encode_uri(cluster_arn)}/channels/#{AWS.Util.encode_uri(channel_arn)}"
