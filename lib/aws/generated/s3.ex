...
defmodule AWS.S3 do
  ...
  requests, code examples, and error handling—see the [Amazon S3 Developer Guide](https://docs.aws.amazon.com/AmazonS3/latest/developerguide/Welcome.html).
  ...
  You can use any toolkit that supports HTTP to use the REST API. You can even use
  a browser
  ...
  """
  @type create_multipart_upload_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type create_session_output() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type upload_part_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type put_object_tagging_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type complete_multipart_upload_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_bucket_metadata_table_configuration_result() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_bucket_analytics_configuration_output() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_bucket_inventory_configurations_output() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_bucket_replication_output() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_object_attributes_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type completed_part() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type storage_class_analysis() :: %{(String.t() | atom()) => any()}
  ...
  @type get_object_annotation_errors() :: no_such_bucket() | no_such_key() | no_such_annotation()
  ...
  @type list_object_annotations_errors() :: invalid_prefix() | no_such_bucket() | no_such_key()
  ...
  **Directory buckets** - If multipart uploads in a
  ...
  use the
  `ListMultipartUploads` operation to list the in-progress multipart uploads in
  the
  ...
  **General purpose bucket permissions** - For information
  about permissions required to use the multipart upload, see [Multipart Upload and
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  def abort_multipart_upload(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  request,
  Amazon S3 concatenates all the parts in ascending order by part number to create
  a new object. In the
  ...
  to finalize. After
  Amazon S3 begins processing the request, it sends an HTTP response header that
  specifies a
  ...
  space characters to
  keep the connection from timing out. A request could fail after the initial `200
  OK` response
  has been sent. This means that a `200 OK` response can contain either a success
  or an error.
  The error response might be embedded in the `200 OK` response. If you call this
  API operation
  ...
  **Directory bucket permissions** - To grant access to this API operation on a
  ...
  might not
  have been uploaded, or the specified ETag might not have matched the uploaded
  part's
  ETag.
  ...
  Description: The list of parts was not in ascending order. The parts list must
  be
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  @spec complete_multipart_upload(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def complete_multipart_upload(%Client{} = client, key, bucket, input, options \\ []) do
  ...
  for Email Grantee Access Control Lists (ACLs). If you attempt to use an Email
  Grantee ACL in a request after October 1, 2025,
  ...
  *Amazon S3 User Guide*.
  ...
  using VPC
  endpoints, your source and destination buckets should be in the same Amazon Web
  Services Region as your VPC
  endpoint.
  ...
  enable a Region for your
  account, see [Enable or disable a Region for standalone
  ...
  For more
  information, see [Transfer Acceleration](https://docs.aws.amazon.com/AmazonS3/latest/dev/transfer-acceleration.html).
  ...
  **General purpose bucket permissions##  - You must have
  permissions in an IAM policy based on the source and destination bucket types in
  a
  ...
  **Directory bucket permissions##  - You must have
  ...
  If the source object that you want to copy is in a directory bucket, you must
  have
  the 
  ...
  *Amazon S3 User Guide*.
  ...
  When the request is an HTTP 1.1 request, the response is chunk encoded. When the
  request is
  ...
  If the error occurs before the copy action starts, you receive a standard Amazon
  S3
  error.
  ...
  S3](https://repost.aws/knowledge-center/s3-resolve-200-internalerror). The `200
  OK` status code
  means the copy was accepted, but it doesn't mean the copy is complete. Another
  example is
  when you disconnect from Amazon S3 before the copy is complete, Amazon S3 might
  cancel the copy and
  you may receive a `200 OK` response. You must stay connected to Amazon S3 until
  the
  entire response is successfully received and processed.

  If you call this API operation directly, make sure to design your application to
  parse
  the content of the response and handle it appropriately. If you use Amazon Web
  Services SDKs, SDKs
  ...
  appropriate).
  If the condition persists, the SDKs throw an exception (or, for the SDKs that
  don't use
  exceptions, they return an error).
  ...
  specify for the
  destination object. The request can also result in a data retrieval charge for
  the source if the
  source storage class bills for data retrieval. If the copy source is in a
  different region, the
  data transfer is billed to the copy source account. For pricing information, see
  ...
  *AccessPointName*-*AccountId*.*outpostID*.s3-outposts.*Region*.amazonaws.com
  ...
  a valid Amazon Web Services Access Key
  ...
  these bucket types, see [Creating, configuring, and working with Amazon S3 buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-buckets-s3.html)
  in the *Amazon S3 User Guide*.

  General purpose buckets exist in a global namespace, which means that each
  bucket name must be unique
  across all Amazon Web Services accounts in all the Amazon Web Services Regions
  within a partition. A partition is a grouping of
  ...
  `aws-eusc`
  (European Sovereign Cloud). When you create a general purpose bucket, you can
  choose to create a bucket in
  the shared global namespace or you can choose to create a bucket in your account
  regional namespace.
  Your account regional namespace is a subdivision of the global namespace that
  only your account can
  ...
  **General purpose buckets** - If you send your
  ...
  Region other than US East (N. Virginia), your application must be able to handle
  307 redirect. For
  more information, see [Virtual hosting of buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/VirtualHosting.html) in
  the *Amazon S3 User Guide*.
  ...
  **S3 Object Ownership** - If your
  ...
  explicitly set S3 Object Ownership for the bucket to a different value than the
  default,
  ...
  share data
  with users outside of your account, you can use bucket policies as needed. For
  more
  ...
  **S3 Block Public Access** - If your specific use
  case requires granting public access to your S3 resources, you can disable Block
  Public
  ...
  Block Public Access, see [Blocking public access to your Amazon S3 storage
  ](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-control-block-public-access.html)
  in the *Amazon S3 User Guide*.
  ...
  **Directory bucket permissions** - You must have the
  `s3express:CreateBucket` permission in an IAM identity-based policy instead of a
  bucket policy.
  ...
  Access
  are not supported for directory buckets. For directory buckets, all Block Public
  Access
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec create_bucket(map(), String.t() | atom(), create_bucket_request(), list()) ::
  ...
  def create_bucket(%Client{} = client, bucket, input, options \\ []) do
    ...
    {headers, input} =
      [
        ...
        {"GrantRead", "x-amz-grant-read"},
        {"GrantFullControl", "x-amz-grant-full-control"},
        {"BucketNamespace", "x-amz-bucket-namespace"},
        {"ACL", "x-amz-acl"}
      ]
      |> Request.build_params(input)
    ...
    options =
      Keyword.put(
        options,
        :response_header_parameters,
        [{"Location", "Location"}, {"x-amz-bucket-arn", "BucketArn"}]
      )
  ...
  *Amazon S3 User Guide*.
  ...
  If you want to encrypt your metadata tables with server-side encryption with Key
  Management Service
  (KMS) keys (SSE-KMS), you need additional permissions in your KMS key policy.
  For more
  information, see [
  ...
  *Amazon S3 User Guide*.
  ...
  information, see [ Integrating Amazon S3 Tables with Amazon Web Services analytics
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec create_bucket_metadata_configuration(
          map(),
          String.t() | atom(),
          create_bucket_metadata_configuration_request(),
          list()
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def create_bucket_metadata_configuration(%Client{} = client, bucket, input, options \\ []) do
    url_path = "/#{AWS.Util.encode_uri(bucket)}?metadataConfiguration"
  ...
  [CreateBucketMetadataConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucketMetadataConfiguration.html) API operation.
  ...
  *Amazon S3 User Guide*.
  ...
  ID is used to
  associate all of the parts in the specific multipart upload. You specify this
  upload ID in each of your
  ...
  the final request to either complete or abort the multipart upload request. For
  ...
  space used to store the parts and stops charging you for storing them only after
  you either complete
  ...
  Otherwise, the incomplete multipart upload becomes eligible for an abort action
  and Amazon S3 aborts the
  multipart upload. For more information, see [Aborting Incomplete Multipart Uploads Using a Bucket Lifecycle
  ...
  *Amazon S3 User Guide*.
  ...
  initiate a
  multipart upload, send one or more requests to upload parts, and then complete
  the multipart
  ...
  **General purpose bucket permissions** - To perform a
  multipart upload with encryption using an Key Management Service (KMS) KMS key,
  ...
  **General purpose buckets** - Server-side encryption is for
  ...
  setting in your
  request takes precedence. If you choose to provide your own encryption key, the
  request
  ...
  (`aws/s3`) and
  KMS customer managed keys stored in Key Management Service (KMS) – If you want
  Amazon Web Services to manage the keys used
  ...
  *Amazon S3 User Guide*.
  ...
  encryption
  keys (SSE-C), see [ Protecting data using server-side encryption with customer-provided encryption keys
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  @spec create_multipart_upload(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def create_multipart_upload(%Client{} = client, key, bucket, input, options \\ []) do
  ...
  include the Availability Zone in the request endpoint, see [S3 Express One Zone APIs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-APIs.html)
  in the
  *Amazon S3 User Guide*.
  ...
  bucket in
  a bucket policy or an IAM identity-based policy. Then, you use IAM credentials
  to make the `CreateSession`
  ...
  credentials
  are scoped to the bucket and expire after 5 minutes. After the expiration time,
  any calls that you make
  ...
  Services SDKs to initiate and manage
  requests to the CreateSession API. For more information, see [Performance guidelines and design
  ...
  **
  ...
  Zonal endpoint API operations, the `CopyObject` API operation doesn't use the
  temporary security
  credentials returned from the `CreateSession` API operation for authentication
  and
  ...
  Zonal endpoint API operations, the `HeadBucket` API operation doesn't use the
  temporary security
  credentials returned from the `CreateSession` API operation for authentication
  and
  authorization. For information about authentication and authorization of the
  ...
  grants `s3express:CreateSession` permission to the bucket. In a policy, you can
  have
  ...
  **Directory bucket permissions** - You must have the
  `s3express:DeleteBucket` permission in an IAM identity-based policy instead of a
  bucket policy.
  Cross-account access to this API operation isn't supported. This operation can
  only be performed by the Amazon Web Services account that owns the resource. For
  more information about directory bucket policies and permissions, see [Amazon Web Services Identity and Access Management (IAM) for S3 Express One
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec delete_bucket(map(), String.t() | atom(), delete_bucket_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec delete_bucket_cors(map(), String.t() | atom(), delete_bucket_cors_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  **Directory buckets** -
  ...
  configuration in
  directory buckets, see [Setting default server-side encryption behavior for directory
  ...
  **General purpose bucket permissions** - The
  ...
  to others.
  For more information about permissions, see [Permissions Related to Bucket Operations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-with-s3-actions.html#using-with-s3-actions-related-to-bucket-subresources)
  ...
  **Directory bucket permissions** - To grant access to
  ...
  Cross-account access to this API operation isn't supported. This operation can
  only be performed by the Amazon Web Services account that owns the resource.
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  and Amazon S3 no longer automatically deletes any objects on the basis of rules
  contained in the deleted
  lifecycle configuration.
  ...
  **General purpose bucket permissions** - By default, all Amazon S3
  resources are private, including buckets, objects, and related subresources (for
  example,
  ...
  **Directory bucket permissions** - You must have the
  ...
  supported. The
  resource owner can optionally grant access permissions to others by creating a
  role or user
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  `DeleteBucketMetadataTableConfiguration` API operation with V2 configurations,
  you
  ...
  `s3:DeleteBucketMetadataTableConfiguration` permission. For more information,
  see
  [Setting up permissions for configuring metadata tables](https://docs.aws.amazon.com/AmazonS3/latest/userguide/metadata-tables-permissions.html)
  in the
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec delete_bucket_metadata_configuration(
          map(),
          String.t() | atom(),
          delete_bucket_metadata_configuration_request(),
          list()
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def delete_bucket_metadata_configuration(%Client{} = client, bucket, input, options \\ []) do
    url_path = "/#{AWS.Util.encode_uri(bucket)}?metadataConfiguration"
  ...
  [DeleteBucketMetadataTableConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucketMetadataTableConfiguration.html) API operation.
  ...
  *Amazon S3 User Guide*.
  ...
  bucket, the calling identity must both have the `DeleteBucketPolicy` permissions
  on the
  ...
  own buckets,
  the root principal in a bucket owner's Amazon Web Services account can perform
  the
  `GetBucketPolicy`, `PutBucketPolicy`, and
  `DeleteBucketPolicy` API actions, even if their bucket policy explicitly denies
  the
  root principal's access. Bucket owner root principals can only be blocked from
  performing these
  ...
  **Directory bucket permissions** - To grant access to
  this API operation, you must have the `s3express:DeleteBucketPolicy` permission
  in
  an IAM identity-based policy instead of a bucket policy. Cross-account access to
  this API operation isn't supported. This operation can only be performed by the
  Amazon Web Services account that owns the resource.
  ...
  *Amazon S3 User Guide*.
  ...
  `200 OK` response if the website configuration you are trying to delete does not
  exist on
  the bucket. Amazon S3 returns a `404` response if the bucket specified in the
  request does not
  exist.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec delete_bucket_website(map(), String.t() | atom(), delete_bucket_website_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  becomes the
  current version of the object. To permanently delete an object in a versioned
  bucket, you must
  include the object’s `versionId` in the request. For more information about
  versioning-enabled buckets, see [Deleting object versions from a versioning-enabled
  ...
  current
  version of the object. If there isn't an object with a null `versionId`, and all
  versions
  of the object have a `versionId`, Amazon S3 does not remove the object and only
  inserts a
  delete marker. To permanently delete an object that has a `versionId`, you must
  include
  the object’s `versionId` in the request. For more information about
  versioning-suspended
  buckets, see [Deleting objects from versioning-suspended
  ...
  *Amazon S3 User Guide*.
  ...
  information about MFA Delete, see [Using MFA Delete](https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMFADelete.html) in
  the *Amazon S3 User
  Guide*. To see sample requests that use versioning, see [Sample Request](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectDELETE.html#ExampleVersionObjectDelete).
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  @spec delete_object(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def delete_object(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  def delete_object_annotation(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  managing object
  tags, see [ Object Tagging](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-tagging.html).
  ...
  @spec delete_object_tagging(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def delete_object_tagging(%Client{} = client, key, bucket, input, options \\ []) do
  ...
  If
  you know the object keys that you want to delete, then this operation provides a
  ...
  of that delete, success or failure, in the response. If the object specified in
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec delete_objects(map(), String.t() | atom(), delete_objects_request(), list()) ::
  ...
  the access control list (ACL) of a bucket. To use `GET` to return the ACL of the
  bucket, you
  ...
  requests to read
  ACLs are still supported and return the `bucket-owner-full-control` ACL with the
  owner
  ...
  """
  @spec get_bucket_acl(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_cors(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_encryption(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  [HeadBucket](https://docs.aws.amazon.com/AmazonS3/latest/API/API_HeadBucket.html)  operation instead. For backward compatibility, Amazon S3 continues to support
  the
  ...
  governed
  by the bucket's policy. In other Regions, the bucket policy doesn't apply, which
  means that
  ...
  is authorized or not. Therefore, we recommend using the `HeadBucket` operation
  for
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_location(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_logging(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_metadata_configuration(
          map(),
          String.t() | atom(),
          String.t() | atom() | nil,
          list()
        ) ::
          {:ok, get_bucket_metadata_configuration_output(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  [GetBucketMetadataTableConfiguration](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketMetadataTableConfiguration.html) API operation.
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  of a bucket.
  However, the bucket owner can use a bucket policy to grant permission to other
  users to read this
  ...
  *Amazon S3 User Guide*.
  ...
  If you are using an identity other than the root user of the Amazon Web Services
  account that owns the
  bucket, the calling identity must both have the `GetBucketPolicy` permissions on
  the
  specified bucket and belong to the bucket owner's account in order to use this
  operation.
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_policy(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  use this operation, you must have the `s3:GetBucketPolicyStatus` permission. For
  more
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_policy_status(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_replication(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_request_payment(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_tagging(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_versioning(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  as website by adding a website configuration. For more information about hosting
  websites, see [Hosting Websites on Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/dev/WebsiteHosting.html).
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_bucket_website(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  **General purpose buckets** - Both the virtual-hosted-style requests
  and the path-style requests are supported. For a virtual hosted-style request
  ...
  **Directory buckets ** -
  ...
  sent
  for the `GetObject` requests, if your object uses server-side encryption with
  Amazon S3
  ...
  **Directory buckets** -
  ...
  header values
  are included only in a successful response, that is, when the HTTP status code
  `200 OK`
  is returned. The headers you can override using the following query parameters
  in the request are
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  `ListParts`. All of the data returned with both of those individual calls can be
  returned
  ...
  **Directory bucket permissions** - To grant access to this API operation on a
  ...
  Management Service
  (KMS) keys (SSE-KMS), dual-layer server-side encryption with Amazon Web Services
  KMS keys (DSSE-KMS), or
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  To use this operation, you must have permission to perform the
  `s3:GetObjectTagging`
  action. By default, the GET action returns information about current version of
  an object. For a
  versioned bucket, you can have multiple versions of an object in your bucket. To
  retrieve tags of any
  other version, use the versionId query parameter. You also need permission for
  the
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec get_public_access_block(map(), String.t() | atom(), String.t() | atom() | nil, list()) ::
  ...
  permission to access it. You can make a `HeadBucket` call on any bucket name to
  any
  Region in the partition, and regardless of the permissions on the bucket, you
  will receive a
  ...
  `404 Not Found` HTTP status code. A message body isn't included, so you can't
  determine
  ...
  **General purpose bucket permissions** - To use this
  ...
  others. For more
  information about permissions, see [Managing access permissions to your Amazon S3
  resources](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-access-control.html)
  in the *Amazon S3 User Guide*.
  ...
  **Directory bucket permissions##  - You must have the
  ...
  `s3express:CreateSession`
  ** permission in the
  `Action` element of a policy. If no session mode is specified, the session will
  be
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec head_bucket(map(), String.t() | atom(), head_bucket_request(), list()) ::
  ...
  , `412 Precondition Failed`, or `304 Not Modified`.
  ...
  *Amazon S3 User Guide*. For more
  information about the permissions to S3 API operations by S3 resource types, see
  [Required permissions for Amazon S3 API
  operations](/AmazonS3/latest/userguide/using-with-s3-policy-actions.html) in the
  *Amazon S3 User Guide*.
  ...
  **Directory bucket permissions** - To grant access to this API operation on a
  ...
  encryption
  keys (SSE-C) when you store the object in Amazon S3, then when you retrieve the
  metadata from the
  object, you must use the following headers to provide the encryption key for the
  server to be able
  ...
  *Amazon S3 User Guide*.
  ...
  def head_object(%Client{} = client, key, bucket, input, options \\ []) do
    url_path = "/#{AWS.Util.encode_uri(bucket)}/#{AWS.Util.encode_multi_segment_uri(key)}"
  ...
  should always check the `IsTruncated` element in the response. If there are no
  more
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  The metrics configurations are only for the request
  metrics of the bucket and do not provide information on daily storage metrics.
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  To grant IAM
  permission to use this operation, you must add the `s3:ListAllMyBuckets` policy
  action.
  ...
  to the default general
  purpose bucket quota of 10,000. If you have an approved general purpose bucket
  quota above 10,000, you
  must send paginated `ListBuckets` requests to list your account’s buckets. All
  unpaginated
  `ListBuckets` requests will be rejected for Amazon Web Services accounts with a
  ...
  For
  more information about directory buckets, see [Directory buckets](https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-buckets-overview.html)
  in the
  *Amazon S3 User Guide*.
  ...
  **Directory buckets** - If multipart uploads in a
  ...
  uploads in the
  response. The limit of 1,000 multipart uploads is also the default value. You
  ...
  **General purpose bucket** - In the
  ...
  uploads with
  the same key, the one that was initiated first will appear before the ones that
  were
  initiated later.
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  to parse the
  contents of the response and handle it appropriately. For more information about
  listing objects, see
  [Listing object keys
  ...
  **General purpose bucket permissions** - To use this
  operation, you must have READ access to the bucket. You must have permission to
  perform the
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  use this revised
  API operation for application development. For backward compatibility, Amazon S3
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  that updates a bucket ACL
  using the request body, then you can continue to use that approach.

  If your bucket uses the bucket owner enforced setting for S3 Object Ownership,
  ACLs are disabled
  and no longer affect permissions. You must use policies to grant access to your
  bucket and the objects
  ...
  supported.
  For more information, see [Controlling object ownership](https://docs.aws.amazon.com/AmazonS3/latest/userguide/about-object-ownership.html)
  in
  the *Amazon S3 User Guide*.
  ...
  explicit access permissions and grantees (Amazon Web Services accounts or Amazon
  S3 groups) who will receive the
  ...
  values in JSON
  format, see the Amazon Web Services CLI example in [ Enabling Amazon S3 server access
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_acl(map(), String.t() | atom(), put_bucket_acl_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  updated daily and
  are based on the object filters that you configure. When selecting data export,
  you specify a
  destination bucket and an optional destination prefix where the file is written.
  You can export the data
  to a destination bucket in a different account. However, the destination bucket
  must be in the same
  Region as the bucket that you are making the PUT analytics configuration to. For
  more information, see
  ...
  policy, see [Granting Permissions for Amazon S3 Inventory and Storage Class
  ...
  *Cause: You are not the owner of the specified bucket, or you do not have the
  ...
  you configure
  rules that identify origins and the HTTP methods that can be executed on your
  bucket. The document is
  ...
  rule that matches the incoming browser request to enable a cross-origin request.
  For a rule to match,
  ...
  request must be one of the `AllowedMethod` elements.
    ...
    *
  Every header specified in the `Access-Control-Request-Headers` request header of
  a
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_cors(map(), String.t() | atom(), put_bucket_cors_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  *Amazon S3 User Guide*.
  ...
  Amazon Web Services KMS keys (DSSE-KMS). If you specify default encryption by
  using SSE-KMS, you can also
  configure [Amazon S3 Bucket Keys](https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-key.html). For
  ...
  to
  SSE-KMS, you should verify that your KMS key ID is correct. Amazon S3 doesn't
  validate the
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_encryption(map(), String.t() | atom(), put_bucket_encryption_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  stored in the S3 Intelligent-Tiering storage class to the Archive Access or Deep
  Archive Access
  tier.
  ...
  *destination* bucket where you want the inventory to be stored, and whether to
  ...
  information, see [Amazon S3 Inventory](https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-inventory.html)
  in the
  Amazon S3 User Guide.

  You must create a bucket policy on the *destination* bucket to grant
  permissions to Amazon S3 to write objects to the bucket in the defined location.
  ...
  *Cause:* You are not the owner of the specified bucket, or you do not have
  ...
  you want
  to retain any configuration details, they must be included in the new lifecycle
  configuration. For
  information about lifecycle configuration, see [Managing your storage lifecycle](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lifecycle-mgmt.html).
  ...
  based only on an object
  key name prefix, which is supported for backward compatibility. For the related
  API description, see
  [PutBucketLifecycle](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketLifecycle.html). 
  ...
  version and
  zero or more noncurrent versions). Amazon S3 provides predefined actions that
  you can specify for
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_logging(map(), String.t() | atom(), put_bucket_logging_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  (Amazon SNS) or Amazon Simple Queue Service (Amazon SQS) destination exists, and
  that the bucket owner
  ...
  you can create per
  bucket, see [Amazon S3 service quotas](https://docs.aws.amazon.com/general/latest/gr/s3.html#limits_s3) in
  *Amazon Web Services General Reference*.
  ...
  includes SNS topic, SQS queue, and Lambda function configurations. When you send
  a PUT request with
  ...
  will also
  include the `x-amz-sns-test-message-id` header containing the message ID of the
  test
  ...
  *Amazon S3 User Guide*.
  ...
  If you are using an identity other than the root user of the Amazon Web Services
  account that owns the
  bucket, the calling identity must both have the `PutBucketPolicy` permissions on
  the
  specified bucket and belong to the bucket owner's account in order to use this
  operation.
  ...
  **Directory buckets ** - The HTTP Host header syntax is
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_policy(map(), String.t() | atom(), put_bucket_policy_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  *Amazon S3 User Guide*.
  ...
  configuration, you
  provide the name of the destination bucket or buckets where you want Amazon S3
  to replicate objects, the
  ...
  maximum of 1,000. Each
  rule identifies a subset of objects to replicate by filtering the objects in the
  source bucket. To
  ...
  created the bucket, can
  perform this operation. The resource owner can also grant others permissions to
  perform the
  operation. For more information about permissions, see [Specifying Permissions in a
  Policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html)
  and [Managing Access Permissions to Your Amazon S3
  Resources](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-access-control.html).
  ...
  from the bucket. This configuration parameter enables the bucket owner (only) to
  specify that the person
  requesting the download will be charged for the download. For more information,
  see [Requester Pays Buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html).
  ...
  the cost of combined resources,
  organize your billing information according to resources with the same tag key
  values. For example, you
  can tag several resources with a specific application name, and then organize
  your billing information
  to see the total cost of that application across several services. For more
  information, see [Cost Allocation and Tagging](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html)
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_tagging(map(), String.t() | atom(), put_bucket_tagging_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  **Suspended**—Disables versioning for the objects in the bucket. All
  ...
  bucket and you want
  to maintain the same permanent delete behavior when you enable versioning, you
  must add a noncurrent
  ...
  subresource. To
  configure a bucket as a website, you can add this subresource on the bucket with
  ...
  users to set the website configuration by writing a bucket policy that grants
  them the
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_bucket_website(map(), String.t() | atom(), put_bucket_website_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  S3 added the entire
  object to the bucket. You cannot use `PutObject` to only update a single piece
  of
  ...
  *Amazon S3 User Guide*.
  ...
  S3 provides features that can
  modify this behavior:

    *

  **S3 Object Lock** - To prevent objects from being deleted
  or overwritten, you can use [Amazon S3 Object Lock](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock.html) in
  the *Amazon S3 User Guide*.
  ...
  **If-None-Match** - Uploads the object only if the object
  key name does not already exist in the specified bucket. Otherwise, Amazon S3
  returns a
  ...
  **S3 Versioning** - When you enable versioning for a bucket,
  ...
  of the objects. For each write request that is made to the same object, Amazon
  S3 automatically generates
  a unique version ID of that object being stored in Amazon S3. You can retrieve,
  replace, or delete any
  ...
  **General purpose bucket** - To ensure that data is not
  ...
  do not match, Amazon S3
  returns an error. Alternatively, when the object's ETag is its MD5 digest, you
  can calculate
  the MD5 while putting the object to Amazon S3 and compare the returned ETag to
  the calculated MD5
  value.
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec put_object(map(), String.t() | atom(), String.t() | atom(), put_object_request(), list()) ::
  ...
  a new or
  existing object in an S3 bucket. You must have the `WRITE_ACP` permission to set
  the ACL of
  an object. For more information, see [What permissions can I grant?](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#permissions)
  in the
  *Amazon S3 User Guide*.
  ...
  information, see [Access Control List (ACL) Overview](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html) in
  the *Amazon S3 User Guide*.
  ...
  Specify a canned ACL with the `x-amz-acl` request header. Amazon S3 supports a
  set
  of predefined ACLs, known as canned ACLs. Each canned ACL has a predefined set
  of grantees and
  ...
  def put_object_acl(%Client{} = client, key, bucket, input, options \\ []) do
    url_path = "/#{AWS.Util.encode_uri(bucket)}/#{AWS.Util.encode_multi_segment_uri(key)}?acl"
  ...
  def put_object_annotation(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
      "/#{AWS.Util.encode_uri(bucket)}/#{AWS.Util.encode_multi_segment_uri(key)}?annotation"
  ...
  @spec put_object_legal_hold(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def put_object_legal_hold(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
      "/#{AWS.Util.encode_uri(bucket)}/#{AWS.Util.encode_multi_segment_uri(key)}?legal-hold"
  ...
  @spec put_object_retention(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def put_object_retention(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
      "/#{AWS.Util.encode_uri(bucket)}/#{AWS.Util.encode_multi_segment_uri(key)}?retention"
  ...
  a key-value pair.
  For more information, see [Object Tagging](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-tagging.html).
  ...
  `InvalidTag` - The tag provided was not a valid tag. This error can occur if
  the tag did not pass input validation. For more information, see [Object Tagging](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-tagging.html).
  ...
  @spec put_object_tagging(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def put_object_tagging(%Client{} = client, key, bucket, input, options \\ []) do
    url_path = "/#{AWS.Util.encode_uri(bucket)}/#{AWS.Util.encode_multi_segment_uri(key)}?tagging"
  ...
  You can use `RenameObject` by specifying an existing object’s name as the source
  and the new
  ...
  **If-None-Match** - Renames the object only if an object
  with the specified name does not already exist in the directory bucket. If you
  don't want to
  overwrite an existing object, you can add the `If-None-Match` conditional header
  with the
  value `‘*’` in the `RenameObject` request. Amazon S3 then returns a
  ...
  `CreateSession` API call on the directory bucket to obtain a session token. With
  the
  ...
  refreshing the session token automatically to avoid service interruptions when a
  session expires.
  In your bucket policy, you can specify the `s3express:SessionMode` condition key
  to
  ...
  learn more about Zonal endpoint API operations, see
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  def rename_object(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  Archive tiers, are not accessible in
  real time. For objects in the S3 Glacier Flexible Retrieval or S3 Glacier Deep
  Archive
  storage classes, you must first initiate a restore request, and then wait until
  a temporary copy
  of the object is available. If you want a permanent copy of the object, create a
  copy of it in the
  Amazon S3 Standard storage class in your S3 bucket. To access an archived
  object, you must restore the
  object for the duration (number of days) that you specify. For objects in the
  Archive Access or
  ...
  objects stored in the S3 Glacier Flexible Retrieval storage class or S3
  Intelligent-Tiering Archive tier.
  Bulk retrievals are also the lowest-cost retrieval option when restoring objects
  from
  S3 Glacier Deep Archive. They typically finish within 48 hours for objects
  stored in
  the S3 Glacier Deep Archive storage class or S3 Intelligent-Tiering Deep Archive
  tier.

  For more information about archive retrieval options and provisioned capacity
  for
  `Expedited` data access, see [Restoring Archived Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/restoring-objects.html)
  in the
  *Amazon S3 User Guide*.
  ...
  *Amazon S3 User Guide*.
  ...
  restoration
  status, in the response. You can use Amazon S3 event notifications to notify you
  when a restore is
  initiated or completed. For more information, see [Configuring Amazon S3 Event Notifications](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html)
  in
  the *Amazon S3 User Guide*.

  After restoring an archived object, you can update the restoration period by
  reissuing the
  request with a new period. Amazon S3 updates the restoration period relative to
  ...
  request. For example,
  if you restore an object copy for 10 days, but the object is scheduled to expire
  in 3 days, Amazon S3
  ...
  *SOAP Fault Code Prefix: N/A*
  ...
  def restore_object(%Client{} = client, key, bucket, input, options \\ []) do
  ...
  statement. In the request, along with the SQL expression, you must also specify
  a data serialization
  format (JSON, CSV, or Apache Parquet) of the object. Amazon S3 uses this format
  to parse object data into
  records, and returns only records that match the specified SQL expression. You
  ...
  *Amazon S3 User Guide*.
  ...
  response. For more information, see [Appendix: SelectObjectContent Response](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTSelectObjectAppendix.html).
  ...
  storage class. For more information about storage classes, see [Using Amazon S3 storage
  ...
  @spec select_object_content(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def select_object_content(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  @doc """
  Enables or disables a live inventory table for an S3 Metadata configuration on a
  general
  purpose bucket.
  ...
  *Amazon S3 User Guide*.
  ...
  If you want to encrypt your inventory table with server-side encryption with Key
  Management Service
  (KMS) keys (SSE-KMS), you need additional permissions in your KMS key policy.
  For more
  information, see [
  ...
  *Amazon S3 User Guide*.
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec update_bucket_metadata_inventory_table_configuration(
          map(),
          String.t() | atom(),
          update_bucket_metadata_inventory_table_configuration_request(),
          list()
  ...
  def update_bucket_metadata_inventory_table_configuration(
    ...
    url_path = "/#{AWS.Util.encode_uri(bucket)}?metadataInventoryTable"
  ...
  must URL encode this value to `my%20%20file.txt`.
  """
  @spec update_bucket_metadata_journal_table_configuration(
          map(),
          String.t() | atom(),
          update_bucket_metadata_journal_table_configuration_request(),
          list()
  ...
  def update_bucket_metadata_journal_table_configuration(
    ...
    url_path = "/#{AWS.Util.encode_uri(bucket)}?metadataJournalTable"
  ...
  *Amazon S3 User Guide*.
  ...
  def update_object_encryption(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  and also defines its position within the object being created. If you upload a
  new part using the same
  part number that was used with a previous part, the previously uploaded part is
  overwritten.

  For information about maximum and minimum part sizes and other multipart upload
  specifications, see
  [Multipart upload limits](https://docs.aws.amazon.com/AmazonS3/latest/userguide/qfacts.html) in
  the *Amazon S3 User Guide*.
  ...
  **General purpose bucket permissions** - To perform a
  ...
  the encrypted
  file parts before it completes the multipart upload. For more information about
  KMS
  permissions, see [Protecting data using server-side encryption with
  KMS](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingKMSEncryption.html)
  in the *Amazon S3 User Guide*. For information
  ...
  **General purpose bucket** - To ensure that data is not corrupted
  ...
  request.
  Amazon S3 checks the part data against the provided MD5 value. If they do not
  match, Amazon S3 returns an
  ...
  more information see [Authenticating Requests: Using the Authorization Header (Amazon Web Services Signature Version
  ...
  **General purpose bucket** - Server-side encryption is for
  ...
  server-side encryption
  using Amazon S3 managed keys (SSE-S3) by default. You can optionally tell Amazon
  S3 to encrypt data at
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  @spec upload_part(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def upload_part(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  Upload](https://docs.aws.amazon.com/AmazonS3/latest/dev/uploadobjusingmpu.html)
  in
  the *Amazon S3 User Guide*. For information about copying objects using a single
  atomic
  action vs. a multipart upload, see [Operations on Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectOperations.html)
  in the
  *Amazon S3 User Guide*.
  ...
  *Amazon S3 User Guide*. For information about the permissions required to
  use the multipart upload API, see [Multipart upload and permissions](https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuAndPermissions.html)
  ...
  **Directory bucket permissions##  - You must have
  ...
  If you want to explicitly restrict the access to be read-only, you can set the
  ...
  *Bucket-name*.s3express-*zone-id*.*region-code*.amazonaws.com
  ...
  @spec upload_part_copy(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def upload_part_copy(%Client{} = client, key, bucket, input, options \\ []) do
    url_path =
  ...
  about Object Lambda access points, see [Transforming objects with Object Lambda access
  ...
  same
  metadata when it internally invokes `GetObject`. When `WriteGetObjectResponse`
  is
  ...
  available in the Amazon Web Services Serverless Application Repository, and can
  be selected through the Amazon Web Services
