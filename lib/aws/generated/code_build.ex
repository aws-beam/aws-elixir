...
defmodule AWS.CodeBuild do
  ...
  """
  @type delete_fleet_output() :: %{String.t() => any()}
  ...
  """
  @type list_curated_environment_images_input() :: %{String.t() => any()}
  ...
  """
  @type list_source_credentials_input() :: %{String.t() => any()}
  ...
  """
  @type delete_report_output() :: %{String.t() => any()}
  ...
  """
  @type delete_report_group_output() :: %{String.t() => any()}
  ...
  """
  @type invalidate_project_cache_output() :: %{String.t() => any()}
  ...
  @spec create_fleet(map(), create_fleet_input(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, account_limit_exceeded_exception()}
          | {:error, invalid_input_exception()}
  ...
  @spec create_webhook(map(), create_webhook_input(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, invalid_input_exception()}
          | {:error, o_auth_provider_exception()}
          | {:error, resource_already_exists_exception()}
