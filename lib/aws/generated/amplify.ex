...
defmodule AWS.Amplify do
  ...
  @type list_apps_errors() ::
          unauthorized_exception() | bad_request_exception() | internal_failure_exception()
  ...
  def create_deployment(%Client{} = client, branch_name, app_id, input, options \\ []) do
    url_path =
  ...
  def delete_branch(%Client{} = client, branch_name, app_id, input, options \\ []) do
  ...
  def delete_domain_association(%Client{} = client, domain_name, app_id, input, options \\ []) do
  ...
  def delete_job(%Client{} = client, job_id, branch_name, app_id, input, options \\ []) do
    url_path =
  ...
  def get_backend_environment(%Client{} = client, environment_name, app_id, options \\ []) do
    url_path =
      "/apps/#{AWS.Util.encode_uri(app_id)}/backendenvironments/#{AWS.Util.encode_uri(environment_name)}"
  ...
  def get_branch(%Client{} = client, branch_name, app_id, options \\ []) do
    url_path = "/apps/#{AWS.Util.encode_uri(app_id)}/branches/#{AWS.Util.encode_uri(branch_name)}"
    headers = []
    query_params = []
  ...
  def get_domain_association(%Client{} = client, domain_name, app_id, options \\ []) do
    url_path = "/apps/#{AWS.Util.encode_uri(app_id)}/domains/#{AWS.Util.encode_uri(domain_name)}"
    headers = []
    query_params = []
  ...
  def get_job(%Client{} = client, job_id, branch_name, app_id, options \\ []) do
    url_path =
      "/apps/#{AWS.Util.encode_uri(app_id)}/branches/#{AWS.Util.encode_uri(branch_name)}/jobs/#{AWS.Util.encode_uri(job_id)}"
  ...
  def list_apps(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
    url_path = "/apps"
    headers = []
    query_params = []
  ...
  *Amplify Hosting User Guide*.
  ...
  def start_deployment(%Client{} = client, branch_name, app_id, input, options \\ []) do
    url_path =
  ...
  def start_job(%Client{} = client, branch_name, app_id, input, options \\ []) do
    url_path =
      "/apps/#{AWS.Util.encode_uri(app_id)}/branches/#{AWS.Util.encode_uri(branch_name)}/jobs"
  ...
  def stop_job(%Client{} = client, job_id, branch_name, app_id, input, options \\ []) do
    url_path =
  ...
  def update_branch(%Client{} = client, branch_name, app_id, input, options \\ []) do
    url_path = "/apps/#{AWS.Util.encode_uri(app_id)}/branches/#{AWS.Util.encode_uri(branch_name)}"
    headers = []
    custom_headers = []
    query_params = []
  ...
  def update_domain_association(%Client{} = client, domain_name, app_id, input, options \\ []) do
    url_path = "/apps/#{AWS.Util.encode_uri(app_id)}/domains/#{AWS.Util.encode_uri(domain_name)}"
    headers = []
    custom_headers = []
    query_params = []
