...
defmodule AWS.MediaPackageV2 do
  ...
  def delete_channel(%Client{} = client, channel_name, channel_group_name, input, options \\ []) do
    url_path =
  ...
  def get_channel(%Client{} = client, channel_name, channel_group_name, options \\ []) do
    url_path =
      "/channelGroup/#{AWS.Util.encode_uri(channel_group_name)}/channel/#{AWS.Util.encode_uri(channel_name)}/"
  ...
  def get_channel_policy(%Client{} = client, channel_name, channel_group_name, options \\ []) do
    url_path =
      "/channelGroup/#{AWS.Util.encode_uri(channel_group_name)}/channel/#{AWS.Util.encode_uri(channel_name)}/policy"
  ...
  def update_channel(%Client{} = client, channel_name, channel_group_name, input, options \\ []) do
    url_path =
      "/channelGroup/#{AWS.Util.encode_uri(channel_group_name)}/channel/#{AWS.Util.encode_uri(channel_name)}/"
