...
defmodule AWS.QLDB do
  ...
  """
  @type cancel_journal_kinesis_stream_request() :: %{String.t() => any()}
  ...
  """
  @type get_digest_request() :: %{String.t() => any()}
  ...
  """
  @type delete_ledger_request() :: %{String.t() => any()}
  ...
  """
  @type describe_ledger_request() :: %{String.t() => any()}
  ...
  """
  @type describe_journal_s3_export_request() :: %{String.t() => any()}
  ...
  """
  @type describe_journal_kinesis_stream_request() :: %{String.t() => any()}
  ...
  @spec cancel_journal_kinesis_stream(
          ...
          | {:error, resource_precondition_not_met_exception()}
