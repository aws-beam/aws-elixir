...
defmodule AWS.NetworkManager do
  ...
  def delete_device(%Client{} = client, global_network_id, device_id, input, options \\ []) do
    url_path =
  ...
  def delete_link(%Client{} = client, link_id, global_network_id, input, options \\ []) do
    url_path =
  ...
  def delete_site(%Client{} = client, site_id, global_network_id, input, options \\ []) do
    url_path =
  ...
  def get_route_analysis(%Client{} = client, route_analysis_id, global_network_id, options \\ []) do
    url_path =
  ...
  def list_core_networks(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
    url_path = "/core-networks"
    headers = []
    query_params = []
  ...
  def update_device(%Client{} = client, global_network_id, device_id, input, options \\ []) do
    url_path =
      "/global-networks/#{AWS.Util.encode_uri(global_network_id)}/devices/#{AWS.Util.encode_uri(device_id)}"
  ...
  def update_link(%Client{} = client, link_id, global_network_id, input, options \\ []) do
    url_path =
      "/global-networks/#{AWS.Util.encode_uri(global_network_id)}/links/#{AWS.Util.encode_uri(link_id)}"
  ...
  def update_site(%Client{} = client, site_id, global_network_id, input, options \\ []) do
    url_path =
      "/global-networks/#{AWS.Util.encode_uri(global_network_id)}/sites/#{AWS.Util.encode_uri(site_id)}"
