...
defmodule AWS.PcaConnectorAd do
  ...
  """
  @type delete_template_group_access_control_entry_request() :: %{String.t() => any()}
  ...
  """
  @type get_directory_registration_request() :: %{String.t() => any()}
  ...
  """
  @type delete_directory_registration_request() :: %{String.t() => any()}
  ...
  """
  @type get_service_principal_name_request() :: %{String.t() => any()}
  ...
  """
  @type get_connector_request() :: %{String.t() => any()}
  ...
  """
  @type delete_service_principal_name_request() :: %{String.t() => any()}
  ...
  """
  @type get_template_group_access_control_entry_request() :: %{String.t() => any()}
