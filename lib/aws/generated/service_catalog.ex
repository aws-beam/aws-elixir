...
defmodule AWS.ServiceCatalog do
  ...
  """
  @type disassociate_service_action_from_provisioning_artifact_output() :: %{String.t() => any()}
  ...
  """
  @type disassociate_budget_from_resource_output() :: %{String.t() => any()}
  ...
  """
  @type disassociate_tag_option_from_resource_output() :: %{String.t() => any()}
  ...
  """
  @type delete_portfolio_output() :: %{String.t() => any()}
  ...
  """
  @type disassociate_principal_from_portfolio_output() :: %{String.t() => any()}
  ...
  """
  @type associate_product_with_portfolio_output() :: %{String.t() => any()}
  ...
  """
  @type disable_aws_organizations_access_output() :: %{String.t() => any()}
  ...
  """
  @type disable_aws_organizations_access_input() :: %{String.t() => any()}
  ...
  """
  @type associate_budget_with_resource_output() :: %{String.t() => any()}
  ...
  """
  @type notify_provision_product_engine_workflow_result_output() :: %{String.t() => any()}
  ...
  """
  @type delete_product_output() :: %{String.t() => any()}
  ...
  """
  @type disassociate_product_from_portfolio_output() :: %{String.t() => any()}
  ...
  """
  @type enable_aws_organizations_access_input() :: %{String.t() => any()}
  ...
  """
  @type enable_aws_organizations_access_output() :: %{String.t() => any()}
  ...
  """
  @type associate_principal_with_portfolio_output() :: %{String.t() => any()}
  ...
  """
  @type delete_provisioned_product_plan_output() :: %{String.t() => any()}
  ...
  """
  @type delete_constraint_output() :: %{String.t() => any()}
  ...
  """
  @type reject_portfolio_share_output() :: %{String.t() => any()}
  ...
  """
  @type get_aws_organizations_access_status_input() :: %{String.t() => any()}
  ...
  """
  @type accept_portfolio_share_output() :: %{String.t() => any()}
  ...
  """
  @type delete_service_action_output() :: %{String.t() => any()}
  ...
  """
  @type associate_service_action_with_provisioning_artifact_output() :: %{String.t() => any()}
  ...
  """
  @type associate_tag_option_with_resource_output() :: %{String.t() => any()}
  ...
  """
  @type delete_provisioning_artifact_output() :: %{String.t() => any()}
  ...
  """
  @type delete_tag_option_output() :: %{String.t() => any()}
  ...
  @spec accept_portfolio_share(map(), accept_portfolio_share_input(), list()) ::
          ...
          | {:error, invalid_parameters_exception()}
  ...
  @spec associate_tag_option_with_resource(
          ...
          | {:error, limit_exceeded_exception()}
          | {:error, resource_not_found_exception()}
          | {:error, tag_option_not_migrated_exception()}
