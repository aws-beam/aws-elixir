...
defmodule AWS.SupportApp do
  ...
  support cases in Slack for your Amazon Web Services account.

  After you configure your Slack workspace and channel with the Amazon Web
  Services Support App, you can perform the following tasks directly in your Slack
  channel:
  ...
  only 100 accounts can add the same Slack channel to the Amazon Web Services
