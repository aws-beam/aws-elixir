...
defmodule AWS.AppSync do
  ...
  @type create_domain_name_errors() ::
          internal_failure_exception() | bad_request_exception() | access_denied_exception()
  ...
  @type get_data_source_introspection_errors() ::
          not_found_exception() | internal_failure_exception() | bad_request_exception()
  ...
  @type get_function_errors() ::
          unauthorized_exception() | not_found_exception() | concurrent_modification_exception()
  ...
  @type list_apis_errors() ::
          unauthorized_exception() | internal_failure_exception() | bad_request_exception()
