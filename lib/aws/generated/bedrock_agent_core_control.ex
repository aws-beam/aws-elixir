...
defmodule AWS.BedrockAgentCoreControl do
  ...
  """
  @type http_connector_source() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type http_connector_target_configuration() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type kms_key_source_type() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type open_responses_evaluator_model_config() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type private_key_jwt_config() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type reasoning_configuration() :: %{(String.t() | atom()) => any()}
  ...
  AgentCore Gateway. Using Cedar or Dogwood, you can define fine-grained policies
  ...
  def delete_harness_endpoint(%Client{} = client, endpoint_name, harness_id, input, options \\ []) do
    url_path =
  ...
  def get_harness_endpoint(%Client{} = client, endpoint_name, harness_id, options \\ []) do
    url_path =
      "/harnesses/#{AWS.Util.encode_uri(harness_id)}/endpoints/#{AWS.Util.encode_uri(endpoint_name)}"
  ...
  Policy generation converts natural language descriptions into Dogwood policy
  ...
  This operation returns the actual Dogwood policies and related artifacts
  produced by the AI-powered policy generation process, allowing users to review
  and select from multiple generated policy options.
  """
  ...
  automatically translated into formal Dogwood policy statements. The generation
  ...
  when you want to describe policy intent naturally rather than learning Dogwood
  ...
  def update_harness_endpoint(%Client{} = client, endpoint_name, harness_id, input, options \\ []) do
    url_path =
      "/harnesses/#{AWS.Util.encode_uri(harness_id)}/endpoints/#{AWS.Util.encode_uri(endpoint_name)}"
