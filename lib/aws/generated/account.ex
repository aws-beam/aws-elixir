...
defmodule AWS.Account do
  ...
  """
  @type disable_region_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_account_information_request() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      get_primary_email_update_status_request() :: %{
        optional("AccountId") => String.t() | atom()
      }

  """
  @type get_primary_email_update_status_request() :: %{(String.t() | atom()) => any()}

  @typedoc """

  ## Example:

      get_primary_email_update_status_response() :: %{
        "Status" => String.t() | atom(),
        "UpdatedAt" => [non_neg_integer()]
      }

  """
  @type get_primary_email_update_status_response() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type start_primary_email_update_response() :: %{(String.t() | atom()) => any()}
  ...
  @type get_primary_email_update_status_errors() ::
          validation_exception()
          | too_many_requests_exception()
          | resource_not_found_exception()
          | internal_server_exception()
  ...
  For more information, see [Enable trusted access for Amazon Web Services Account Management](https://docs.aws.amazon.com/accounts/latest/reference/using-orgs-trusted-access.html).
  """
  ...
  """
  @spec get_gov_cloud_account_information(
          map(),
          get_gov_cloud_account_information_request(),
          list()
        ) ::
          {:ok, get_gov_cloud_account_information_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, get_gov_cloud_account_information_errors()}
  def get_gov_cloud_account_information(%Client{} = client, input, options \\ []) do
    url_path = "/getGovCloudAccountInformation"
    headers = []
    custom_headers = []
    query_params = []
  ...
  For complete details about how to update the primary email address, see [Update the primary email address for your AWS
  account](https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-root-user-email.html).
  """
  @spec get_primary_email_update_status(map(), get_primary_email_update_status_request(), list()) ::
          {:ok, get_primary_email_update_status_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, get_primary_email_update_status_errors()}
  def get_primary_email_update_status(%Client{} = client, input, options \\ []) do
    url_path = "/getPrimaryEmailUpdateStatus"
    headers = []
    custom_headers = []
    query_params = []
