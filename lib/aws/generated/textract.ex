...
defmodule AWS.Textract do
  ...
  """
  @type delete_adapter_response() :: %{String.t() => any()}
  ...
  """
  @type delete_adapter_version_response() :: %{String.t() => any()}
  ...
  *Name:* is the key. *Ana Silva Carolina* is
  ...
  @spec analyze_document(map(), analyze_document_request(), list()) ::
          ...
          | {:error, bad_document_exception()}
          | {:error, document_too_large_exception()}
          ...
          | {:error, unsupported_document_exception()}
  ...
  @spec create_adapter_version(map(), create_adapter_version_request(), list()) ::
          ...
          | {:error, idempotent_parameter_mismatch_exception()}
          | {:error, internal_server_error()}
          | {:error, invalid_kms_key_exception()}
          | {:error, invalid_parameter_exception()}
          | {:error, invalid_s3_object_exception()}
          | {:error, limit_exceeded_exception()}
          | {:error, provisioned_throughput_exceeded_exception()}
  ...
  *Name:* is the key. *Ana Silva Carolina* is
  ...
  @spec get_document_analysis(map(), get_document_analysis_request(), list()) ::
          ...
          | {:error, access_denied_exception()}
          | {:error, internal_server_error()}
          | {:error, invalid_job_id_exception()}
          | {:error, invalid_kms_key_exception()}
          | {:error, invalid_parameter_exception()}
          | {:error, invalid_s3_object_exception()}
          | {:error, provisioned_throughput_exceeded_exception()}
