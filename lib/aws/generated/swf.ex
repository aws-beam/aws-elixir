...
defmodule AWS.SWF do
  ...
  *.
  ...
  """
  @type count_closed_workflow_executions_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type describe_domain_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type get_workflow_execution_history_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type lambda_function_started_event_attributes() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_closed_workflow_executions_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type poll_for_decision_task_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type request_cancel_workflow_execution_input() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type timer_canceled_event_attributes() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      workflow_type_configuration() :: %{
        ...
        "defaultExecutionStartToCloseTimeout" => String.t() | atom(),
        "defaultLambdaRole" => String.t() | atom(),
        "defaultTaskList" => task_list(),
        "defaultTaskPriority" => String.t() | atom(),
        "defaultTaskStartToCloseTimeout" => String.t() | atom()
      }
  ...
  """
  @type workflow_type_configuration() :: %{(String.t() | atom()) => any()}
  ...
  @type count_closed_workflow_executions_errors() ::
          unknown_resource_fault() | operation_not_permitted_fault()
  ...
  @type delete_activity_type_errors() ::
          unknown_resource_fault() | type_not_deprecated_fault() | operation_not_permitted_fault()

  @type delete_workflow_type_errors() ::
          unknown_resource_fault() | type_not_deprecated_fault() | operation_not_permitted_fault()

  @type deprecate_activity_type_errors() ::
          unknown_resource_fault() | type_deprecated_fault() | operation_not_permitted_fault()

  @type deprecate_domain_errors() ::
          unknown_resource_fault() | operation_not_permitted_fault() | domain_deprecated_fault()
  ...
  @type describe_domain_errors() :: unknown_resource_fault() | operation_not_permitted_fault()
  ...
  @type list_activity_types_errors() :: unknown_resource_fault() | operation_not_permitted_fault()
  ...
  @type list_tags_for_resource_errors() ::
          unknown_resource_fault() | operation_not_permitted_fault() | limit_exceeded_fault()

  @type list_workflow_types_errors() :: unknown_resource_fault() | operation_not_permitted_fault()
  ...
  @type undeprecate_activity_type_errors() ::
          unknown_resource_fault() | type_already_exists_fault() | operation_not_permitted_fault()
