...
defmodule AWS.MemoryDB do
  ...
  @spec create_acl(map(), create_acl_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, acl_already_exists_fault()}
          | {:error, acl_quota_exceeded_fault()}
  ...
  @spec create_cluster(map(), create_cluster_request(), list()) ::
          ...
          | {:error, parameter_group_not_found_fault()}
          | {:error, service_linked_role_not_found_fault()}
          | {:error, shards_per_cluster_quota_exceeded_fault()}
          | {:error, subnet_group_not_found_fault()}
          | {:error, tag_quota_per_resource_exceeded()}
  ...
  @spec create_parameter_group(map(), create_parameter_group_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, invalid_parameter_combination_exception()}
          | {:error, invalid_parameter_group_state_fault()}
          | {:error, invalid_parameter_value_exception()}
          | {:error, parameter_group_already_exists_fault()}
          | {:error, parameter_group_quota_exceeded_fault()}
          | {:error, service_linked_role_not_found_fault()}
          | {:error, tag_quota_per_resource_exceeded()}
  ...
  @spec create_subnet_group(map(), create_subnet_group_request(), list()) ::
          ...
          | {:error, service_linked_role_not_found_fault()}
          | {:error, subnet_group_already_exists_fault()}
          | {:error, subnet_group_quota_exceeded_fault()}
          | {:error, subnet_not_allowed_fault()}
          | {:error, subnet_quota_exceeded_fault()}
          | {:error, tag_quota_per_resource_exceeded()}
  ...
  @spec delete_subnet_group(map(), delete_subnet_group_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, service_linked_role_not_found_fault()}
          | {:error, subnet_group_in_use_fault()}
          | {:error, subnet_group_not_found_fault()}
  ...
  @spec describe_reserved_nodes_offerings(
          ...
          | {:error, invalid_parameter_combination_exception()}
          | {:error, invalid_parameter_value_exception()}
          | {:error, reserved_nodes_offering_not_found_fault()}
          | {:error, service_linked_role_not_found_fault()}
  ...
  @spec update_cluster(map(), update_cluster_request(), list()) ::
          ...
          | {:error, invalid_cluster_state_fault()}
          | {:error, invalid_kms_key_fault()}
          | {:error, invalid_node_state_fault()}
          | {:error, invalid_parameter_combination_exception()}
          | {:error, invalid_parameter_value_exception()}
          | {:error, invalid_vpc_network_state_fault()}
          | {:error, node_quota_for_cluster_exceeded_fault()}
