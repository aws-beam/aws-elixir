...
defmodule AWS.MarketplaceMetering do
  ...
  *
  ...
  @spec batch_meter_usage(map(), batch_meter_usage_request(), list()) ::
          ...
          | {:error, disabled_api_exception()}
          | {:error, internal_service_error_exception()}
          | {:error, invalid_customer_identifier_exception()}
          | {:error, invalid_product_code_exception()}
          | {:error, invalid_tag_exception()}
          | {:error, invalid_usage_allocations_exception()}
          | {:error, invalid_usage_dimension_exception()}
          | {:error, throttling_exception()}
          | {:error, timestamp_out_of_bounds_exception()}
  ...
  @spec meter_usage(map(), meter_usage_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, customer_not_entitled_exception()}
          | {:error, duplicate_request_exception()}
          | {:error, internal_service_error_exception()}
          | {:error, invalid_endpoint_region_exception()}
          | {:error, invalid_product_code_exception()}
          | {:error, invalid_tag_exception()}
          | {:error, invalid_usage_allocations_exception()}
          | {:error, invalid_usage_dimension_exception()}
  ...
  *Metering*: `RegisterUsage` meters software use
  ...
  @spec register_usage(map(), register_usage_request(), list()) ::
          ...
          | {:error, internal_service_error_exception()}
          | {:error, invalid_product_code_exception()}
          | {:error, invalid_public_key_version_exception()}
          | {:error, invalid_region_exception()}
          | {:error, platform_not_supported_exception()}
          | {:error, throttling_exception()}
