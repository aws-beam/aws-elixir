...
defmodule AWS.IoTTwinMaker do
  ...
  """
  @type cancel_metadata_transfer_job_request() :: %{String.t() => any()}
  ...
  """
  @type get_pricing_plan_request() :: %{String.t() => any()}
  ...
  """
  @type get_entity_request() :: %{String.t() => any()}
  ...
  """
  @type get_metadata_transfer_job_request() :: %{String.t() => any()}
  ...
  """
  @type get_workspace_request() :: %{String.t() => any()}
  ...
  """
  @type get_scene_request() :: %{String.t() => any()}
  ...
  """
  @type delete_sync_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_scene_response() :: %{String.t() => any()}
  ...
  """
  @type delete_component_type_request() :: %{String.t() => any()}
  ...
  """
  @type delete_scene_request() :: %{String.t() => any()}
  ...
  """
  @type get_component_type_request() :: %{String.t() => any()}
  ...
  @spec get_property_value(map(), String.t(), get_property_value_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, access_denied_exception()}
          | {:error, connector_failure_exception()}
          | {:error, connector_timeout_exception()}
          | {:error, internal_server_exception()}
          | {:error, resource_not_found_exception()}
          | {:error, throttling_exception()}
          | {:error, validation_exception()}
