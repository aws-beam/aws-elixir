...
defmodule AWS.MPA do
  ...
  *Multi-party approval User Guide*.
  ...
  """
  @type policy_version_summary() :: %{String.t() => any()}
  ...
  ## Example:
      ...
      get_session_response_approver_response() :: %{
        "ApproverId" => String.t(),
        "IdentityId" => String.t(),
        "IdentitySourceArn" => String.t(),
        "Response" => list(any()),
        "ResponseTime" => non_neg_integer()
      }

  """
  @type get_session_response_approver_response() :: %{String.t() => any()}
  ...
  """
  @type start_active_approval_team_deletion_response() :: %{String.t() => any()}
  ...
  ## Example:
      ...
      get_session_response() :: %{
        ...
        "ProtectedResourceArn" => String.t(),
        "RequesterAccountId" => String.t(),
        "RequesterComment" => String.t(),
        "RequesterPrincipalArn" => String.t(),
        "RequesterRegion" => String.t(),
        "RequesterServicePrincipal" => String.t(),
        "SessionArn" => String.t(),
        "Status" => list(any()),
        "StatusCode" => list(any()),
  ...
  """
  @type get_identity_source_response() :: %{String.t() => any()}
  ...
  ## Example:
      ...
      get_approval_team_response() :: %{
        ...
        "StatusCode" => list(any()),
        "StatusMessage" => String.t(),
        "UpdateSessionArn" => String.t(),
        "VersionId" => String.t()
      }

  """
  @type get_approval_team_response() :: %{String.t() => any()}
  ...
  """
  @type update_approval_team_response() :: %{String.t() => any()}
  ...
  """
  @type iam_identity_center() :: %{String.t() => any()}
  ...
  """
  @type create_identity_source_response() :: %{String.t() => any()}
  ...
  """
  @type identity_source_for_list() :: %{String.t() => any()}
  ...
  """
  @type policy_reference() :: %{String.t() => any()}
  ...
  """
  @type list_identity_sources_response() :: %{String.t() => any()}
  ...
  ## Example:
      ...
      get_approval_team_response_approver() :: %{
        "ApproverId" => String.t(),
        "PrimaryIdentityId" => String.t(),
        "PrimaryIdentitySourceArn" => String.t(),
        "PrimaryIdentityStatus" => list(any()),
        "ResponseTime" => non_neg_integer()
      }

  """
  @type get_approval_team_response_approver() :: %{String.t() => any()}
  ...
  """
  @type approval_team_request_approver() :: %{String.t() => any()}
  ...
  """
  @type start_active_approval_team_deletion_request() :: %{String.t() => any()}
  ...
  """
  @type list_approval_teams_response() :: %{String.t() => any()}
  ...
  ## Example:
      ...
      iam_identity_center_for_list() :: %{
        "ApprovalPortalUrl" => String.t(),
        "InstanceArn" => String.t(),
        "Region" => String.t()
      }

  """
  @type iam_identity_center_for_list() :: %{String.t() => any()}
  ...
  """
  @type list_approval_teams_request() :: %{String.t() => any()}
  ...
  """
  @type list_resource_policies_response_resource_policy() :: %{String.t() => any()}
  ...
  """
  @type create_approval_team_response() :: %{String.t() => any()}
  ...
  """
  @type create_approval_team_request() :: %{String.t() => any()}
  ...
  """
  @type iam_identity_center_for_get() :: %{String.t() => any()}
  ...
  """
  @type list_resource_policies_response() :: %{String.t() => any()}
  ...
  """
  @type list_identity_sources_request() :: %{String.t() => any()}
  ...
  """
  @type create_identity_source_request() :: %{String.t() => any()}
  ...
  """
  @type list_approval_teams_response_approval_team() :: %{String.t() => any()}
  ...
  """
  @type list_sessions_response_session() :: %{String.t() => any()}
  ...
  """
  @type identity_source_parameters() :: %{String.t() => any()}
  ...
  """
  @type pending_update() :: %{String.t() => any()}
  ...
  """
  @type update_approval_team_request() :: %{String.t() => any()}
  ...
  """
  @type mof_n_approval_strategy() :: %{String.t() => any()}
  ...
  """
  @spec cancel_session(map(), String.t(), cancel_session_request(), list()) ::
  ...
  *Multi-party approval User Guide*.
  ...
  the *Multi-party approval User Guide*.
  """
  @spec delete_identity_source(map(), String.t(), delete_identity_source_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  ...
  *Multi-party approval User Guide*.
  ...
  """
  @spec get_approval_team(map(), String.t(), list()) ::
  ...
  the *Multi-party approval User Guide*.
  """
  @spec get_identity_source(map(), String.t(), list()) ::
  ...
  in the *Multi-party approval User Guide*.
  """
  @spec get_policy_version(map(), String.t(), list()) ::
  ...
  in the *Multi-party approval User Guide*.
  """
  @spec list_policy_versions(map(), String.t(), list_policy_versions_request(), list()) ::
  ...
  """
  @spec list_resource_policies(map(), String.t(), list_resource_policies_request(), list()) ::
  ...
  the *Multi-party approval User Guide*.
  """
  @spec list_sessions(map(), String.t(), list_sessions_request(), list()) ::
  ...
  """
  @spec update_approval_team(map(), String.t(), update_approval_team_request(), list()) ::
