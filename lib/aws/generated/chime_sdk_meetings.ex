...
defmodule AWS.ChimeSDKMeetings do
  ...
  For more information about the meeting APIs, see [Amazon Chime SDK meetings](http://amazonaws.com/chime/latest/APIReference/API_Operations_Amazon_Chime_SDK_meetings).
  """
