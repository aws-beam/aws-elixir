...
defmodule AWS.EMRServerless do
  ...
  """
  @type image_configuration_input() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      worker_resource_config() :: %{
        "cpu" => String.t() | Atom.t(),
        "disk" => String.t() | Atom.t(),
        "diskType" => String.t() | Atom.t(),
        "memory" => String.t() | Atom.t()
      }

  """
  @type worker_resource_config() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_job_run_attempts_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_job_run_attempts_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type initial_capacity_config() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      list_job_runs_request() :: %{
        ...
        optional("maxResults") => [integer()],
        optional("mode") => String.t() | Atom.t(),
        optional("nextToken") => String.t() | Atom.t(),
        optional("states") => list(String.t() | Atom.t())
      }
  ...
  """
  @type maximum_allowed_resources() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type job_run_attempt_summary() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type identity_center_configuration_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type auto_start_config() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type auto_stop_config() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type worker_type_specification() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      job_run_execution_iam_policy() :: %{
        ...
        "policyArns" => list(String.t() | Atom.t())
      }

  """
  @type job_run_execution_iam_policy() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type spark_submit() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      prometheus_monitoring_configuration() :: %{
        "remoteWriteUrl" => String.t() | Atom.t()
      }

  """
  @type prometheus_monitoring_configuration() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      start_job_run_response() :: %{
        ...
        required("jobRunId") => String.t() | Atom.t()
      }
  ...
  """
  @type get_dashboard_for_job_run_response() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      create_application_request() :: %{
        optional("architecture") => String.t() | Atom.t(),
  ...
  """
  @type interactive_configuration() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type worker_type_specification_input() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      hive() :: %{
        "initQueryFile" => String.t() | Atom.t(),
        "parameters" => String.t() | Atom.t(),
        "query" => String.t() | Atom.t()
      }

  """
  @type hive() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type scheduler_configuration() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_dashboard_for_job_run_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type total_resource_utilization() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type managed_persistence_monitoring_configuration() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type cancel_job_run_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type cloud_watch_logging_configuration() :: %{String.t() | Atom.t() => any()}
