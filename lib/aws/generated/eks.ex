...
defmodule AWS.EKS do
  ...
  """
  @type deregister_cluster_request() :: %{String.t() => any()}
  ...
  """
  @type disassociate_access_policy_request() :: %{String.t() => any()}
  ...
  """
  @type delete_eks_anywhere_subscription_request() :: %{String.t() => any()}
  ...
  """
  @type disassociate_access_policy_response() :: %{String.t() => any()}
  ...
  """
  @type describe_fargate_profile_request() :: %{String.t() => any()}
  ...
  """
  @type describe_nodegroup_request() :: %{String.t() => any()}
  ...
  """
  @type delete_fargate_profile_request() :: %{String.t() => any()}
  ...
  """
  @type delete_pod_identity_association_request() :: %{String.t() => any()}
  ...
  """
  @type describe_access_entry_request() :: %{String.t() => any()}
  ...
  """
  @type describe_pod_identity_association_request() :: %{String.t() => any()}
  ...
  """
  @type delete_access_entry_request() :: %{String.t() => any()}
  ...
  """
  @type describe_addon_request() :: %{String.t() => any()}
  ...
  """
  @type describe_eks_anywhere_subscription_request() :: %{String.t() => any()}
  ...
  """
  @type delete_access_entry_response() :: %{String.t() => any()}
  ...
  """
  @type delete_nodegroup_request() :: %{String.t() => any()}
  ...
  *Amazon EKS User Guide*.
  ...
  @spec create_cluster(map(), create_cluster_request(), list()) ::
          ...
          | {:error, unsupported_availability_zone_exception()}
  ...
  *Amazon EKS User Guide*.
  ...
  @spec register_cluster(map(), register_cluster_request(), list()) ::
          ...
          | {:error, resource_in_use_exception()}
          | {:error, resource_limit_exceeded_exception()}
          | {:error, resource_propagation_delay_exception()}
          | {:error, server_exception()}
          | {:error, service_unavailable_exception()}
