...
defmodule AWS.AmplifyBackend do
  ...
  """
  @type remove_backend_config_request() :: %{String.t() => any()}
  ...
  """
  @type get_backend_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_backend_request() :: %{String.t() => any()}
  ...
  """
  @type get_token_request() :: %{String.t() => any()}
