...
defmodule AWS.Inspector2 do
  ...
  """
  @type update_encryption_key_response() :: %{String.t() => any()}
  ...
  """
  @type stop_cis_session_response() :: %{String.t() => any()}
  ...
  """
  @type get_delegated_admin_account_request() :: %{String.t() => any()}
  ...
  """
  @type send_cis_session_health_response() :: %{String.t() => any()}
  ...
  """
  @type start_cis_session_response() :: %{String.t() => any()}
  ...
  """
  @type get_ec2_deep_inspection_configuration_request() :: %{String.t() => any()}
  ...
  """
  @type one_time_schedule() :: %{String.t() => any()}
  ...
  """
  @type send_cis_session_telemetry_response() :: %{String.t() => any()}
  ...
  """
  @type update_org_ec2_deep_inspection_configuration_response() :: %{String.t() => any()}
  ...
  """
  @type reset_encryption_key_response() :: %{String.t() => any()}
