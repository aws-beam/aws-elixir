...
defmodule AWS.TranscribeStreaming do
  ...
  **HealthScribe transcriptions** are designed to
  ...
  """
  @type issue_detected() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      start_medical_stream_transcription_request() :: %{
        ...
        optional("VocabularyName") => String.t() | Atom.t(),
  ...
  """
  @type start_medical_stream_transcription_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_encryption_settings() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_medical_scribe_stream_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type points_of_interest() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_stream_details() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_audio_event() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_post_stream_analytics_settings() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type character_offsets() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type audio_event() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      clinical_note_generation_settings() :: %{
        ...
        "OutputBucketName" => String.t() | Atom.t()
      }
  ...
  """
  @type medical_alternative() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      category_event() :: %{
        "MatchedCategories" => list(String.t() | Atom.t()),
        "MatchedDetails" => map()
      }

  """
  @type category_event() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_post_stream_analytics_result() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_configuration_event() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type language_with_score() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_transcript_event() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_entity() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_medical_scribe_stream_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_call_analytics_stream_transcription_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_medical_stream_transcription_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type call_analytics_item() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type call_analytics_entity() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_stream_transcription_response() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_transcript_event() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      start_stream_transcription_request() :: %{
        ...
        optional("LanguageModelName") => String.t() | Atom.t(),
        optional("LanguageOptions") => String.t() | Atom.t(),
        optional("NumberOfChannels") => integer(),
        optional("PartialResultsStability") => list(any()),
        optional("PiiEntityTypes") => String.t() | Atom.t(),
        optional("PreferredLanguage") => list(any()),
        optional("SessionId") => String.t() | Atom.t(),
        optional("ShowSpeakerLabel") => boolean(),
        optional("VocabularyFilterMethod") => list(any()),
        optional("VocabularyFilterName") => String.t() | Atom.t(),
        optional("VocabularyFilterNames") => String.t() | Atom.t(),
        optional("VocabularyName") => String.t() | Atom.t(),
        optional("VocabularyNames") => String.t() | Atom.t(),
        required("AudioStream") => list(),
        required("MediaEncoding") => list(any()),
        required("MediaSampleRateHertz") => integer()
      }
  ...
  """
  @type start_stream_transcription_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_result() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_call_analytics_stream_transcription_request() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type start_medical_scribe_stream_request() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      utterance_event() :: %{
        ...
        "Sentiment" => list(any()),
        "Transcript" => String.t() | Atom.t(),
        "UtteranceId" => String.t() | Atom.t()
      }

  """
  @type utterance_event() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_transcript_item() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_session_control_event() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_scribe_transcript_segment() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type medical_item() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      clinical_note_generation_result() :: %{
        "ClinicalNoteOutputLocation" => String.t() | Atom.t(),
        "FailureReason" => String.t() | Atom.t(),
        "Status" => list(any()),
        "TranscriptOutputLocation" => String.t() | Atom.t()
      }

  """
  @type clinical_note_generation_result() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type alternative() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @spec get_medical_scribe_stream(map(), String.t() | Atom.t(), list()) ::
