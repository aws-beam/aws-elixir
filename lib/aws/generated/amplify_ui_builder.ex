...
defmodule AWS.AmplifyUIBuilder do
  ...
  """
  @type no_api_render_config() :: %{String.t() => any()}
  ...
  """
  @type get_theme_request() :: %{String.t() => any()}
  ...
  """
  @type data_store_render_config() :: %{String.t() => any()}
  ...
  """
  @type delete_form_request() :: %{String.t() => any()}
  ...
  """
  @type get_form_request() :: %{String.t() => any()}
  ...
  """
  @type get_metadata_request() :: %{String.t() => any()}
  ...
  """
  @type get_codegen_job_request() :: %{String.t() => any()}
