...
defmodule AWS.ResourceExplorer2 do
  ...
  Resource Explorer [creates and maintains an index](https://docs.aws.amazon.com/arexug/mainline/getting-started-terms-and-concepts.html#term-index)
  ...
  account](https://docs.aws.amazon.com/arexug/mainline/manage-aggregator-region-turn-on.html),
  ...
  for Resource Explorer, then this operation also [creates a service-linked role](https://docs.aws.amazon.com/arexug/mainline/security_iam_service-linked-roles.html)
  ...
  **Resource**: No specific resource (*).
  ...
  Resource Explorer views, see [Managing views](https://docs.aws.amazon.com/arexug/mainline/manage-views.html) in the
  *Amazon Web Services Resource Explorer User Guide*.
  ...
  index](https://docs.aws.amazon.com/arexug/mainline/manage-aggregator-region.html)
  in the *Amazon Web Services Resource Explorer User Guide*.
