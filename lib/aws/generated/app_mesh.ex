...
defmodule AWS.AppMesh do
  ...
  def create_route(%Client{} = client, virtual_router_name, mesh_name, input, options \\ []) do
    url_path =
  ...
  def delete_virtual_node(%Client{} = client, virtual_node_name, mesh_name, input, options \\ []) do
    url_path =
  ...
  def list_meshes(%Client{} = client, next_token \\ nil, limit \\ nil, options \\ []) do
    url_path = "/v20190125/meshes"
    headers = []
    query_params = []
  ...
  def update_virtual_node(%Client{} = client, virtual_node_name, mesh_name, input, options \\ []) do
    url_path =
      "/v20190125/meshes/#{AWS.Util.encode_uri(mesh_name)}/virtualNodes/#{AWS.Util.encode_uri(virtual_node_name)}"
