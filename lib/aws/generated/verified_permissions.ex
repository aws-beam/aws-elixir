...
defmodule AWS.VerifiedPermissions do
  ...
  **Do not include personally identifying, confidential,
  ...
  """
  @type delete_policy_store_output() :: %{String.t() => any()}
  ...
  """
  @type delete_identity_source_output() :: %{String.t() => any()}
  ...
  """
  @type delete_policy_template_output() :: %{String.t() => any()}
  ...
  """
  @type delete_policy_output() :: %{String.t() => any()}
