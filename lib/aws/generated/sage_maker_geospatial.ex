...
defmodule AWS.SageMakerGeospatial do
  ...
  """
  @type delete_vector_enrichment_job_input() :: %{String.t() => any()}
  ...
  """
  @type get_raster_data_collection_input() :: %{String.t() => any()}
  ...
  """
  @type delete_earth_observation_job_input() :: %{String.t() => any()}
  ...
  """
  @type delete_earth_observation_job_output() :: %{String.t() => any()}
  ...
  """
  @type get_vector_enrichment_job_input() :: %{String.t() => any()}
  ...
  """
  @type delete_vector_enrichment_job_output() :: %{String.t() => any()}
  ...
  """
  @type land_cover_segmentation_config_input() :: %{String.t() => any()}
  ...
  """
  @type cloud_masking_config_input() :: %{String.t() => any()}
  ...
  """
  @type stop_vector_enrichment_job_output() :: %{String.t() => any()}
  ...
  """
  @type get_earth_observation_job_input() :: %{String.t() => any()}
  ...
  """
  @type stop_earth_observation_job_output() :: %{String.t() => any()}
