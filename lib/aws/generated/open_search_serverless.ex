...
defmodule AWS.OpenSearchServerless do
  ...
  """
  @type delete_security_config_response() :: %{String.t() => any()}
  ...
  """
  @type get_policies_stats_request() :: %{String.t() => any()}
  ...
  """
  @type delete_security_policy_response() :: %{String.t() => any()}
  ...
  @spec create_collection(map(), create_collection_request(), list()) ::
          ...
          | {:error, conflict_exception()}
          | {:error, internal_server_exception()}
          | {:error, ocu_limit_exceeded_exception()}
          | {:error, service_quota_exceeded_exception()}
          | {:error, validation_exception()}
