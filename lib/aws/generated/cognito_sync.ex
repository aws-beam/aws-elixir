...
defmodule AWS.CognitoSync do
  ...
  def describe_identity_usage(%Client{} = client, identity_pool_id, identity_id, options \\ []) do
    url_path =
  ...
  def register_device(%Client{} = client, identity_pool_id, identity_id, input, options \\ []) do
    url_path =
