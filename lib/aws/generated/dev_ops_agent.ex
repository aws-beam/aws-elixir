...
defmodule AWS.DevOpsAgent do
  ...
  def create_asset_file(%Client{} = client, path, asset_id, agent_space_id, input, options \\ []) do
    url_path =
  ...
  def delete_asset(%Client{} = client, asset_id, agent_space_id, input, options \\ []) do
    url_path =
  ...
  def delete_asset_file(%Client{} = client, path, asset_id, agent_space_id, input, options \\ []) do
    url_path =
      "/asset/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/assets/#{AWS.Util.encode_uri(asset_id)}/files/#{AWS.Util.encode_multi_segment_uri(path)}"
  ...
  def delete_trigger(%Client{} = client, trigger_id, agent_space_id, input, options \\ []) do
    url_path =
  ...
  def get_asset(%Client{} = client, asset_id, agent_space_id, asset_version \\ nil, options \\ []) do
    url_path =
      "/asset/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/assets/#{AWS.Util.encode_uri(asset_id)}"
  ...
  def get_association(%Client{} = client, association_id, agent_space_id, options \\ []) do
    url_path =
      "/v1/agentspaces/#{AWS.Util.encode_uri(agent_space_id)}/associations/#{AWS.Util.encode_uri(association_id)}"
  ...
  def get_backlog_task(%Client{} = client, task_id, agent_space_id, options \\ []) do
    url_path =
  ...
  def get_trigger(%Client{} = client, trigger_id, agent_space_id, options \\ []) do
    url_path =
      "/trigger/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/triggers/#{AWS.Util.encode_uri(trigger_id)}"
  ...
  def list_asset_types(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
  ...
  def list_webhooks(%Client{} = client, association_id, agent_space_id, input, options \\ []) do
    url_path =
  ...
  def update_asset(%Client{} = client, asset_id, agent_space_id, input, options \\ []) do
    url_path =
      "/asset/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/assets/#{AWS.Util.encode_uri(asset_id)}"
  ...
  def update_asset_file(%Client{} = client, path, asset_id, agent_space_id, input, options \\ []) do
    url_path =
      "/asset/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/assets/#{AWS.Util.encode_uri(asset_id)}/files/#{AWS.Util.encode_multi_segment_uri(path)}"
  ...
  def update_association(%Client{} = client, association_id, agent_space_id, input, options \\ []) do
    url_path =
      "/v1/agentspaces/#{AWS.Util.encode_uri(agent_space_id)}/associations/#{AWS.Util.encode_uri(association_id)}"
  ...
  def update_backlog_task(%Client{} = client, task_id, agent_space_id, input, options \\ []) do
    url_path =
      "/backlog/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/tasks/#{AWS.Util.encode_uri(task_id)}"
  ...
  def update_goal(%Client{} = client, goal_id, agent_space_id, input, options \\ []) do
    url_path =
  ...
  def update_trigger(%Client{} = client, trigger_id, agent_space_id, input, options \\ []) do
    url_path =
      "/trigger/agent-space/#{AWS.Util.encode_uri(agent_space_id)}/triggers/#{AWS.Util.encode_uri(trigger_id)}"
