...
defmodule AWS.Route53Domains do
  ...
  @type cancel_domain_transfer_to_another_aws_account_errors() ::
          operation_limit_exceeded() | invalid_input() | unsupported_t_l_d()

  @type check_domain_availability_errors() ::
          t_l_d_in_maintenance() | invalid_input() | unsupported_t_l_d()

  @type check_domain_transferability_errors() ::
          t_l_d_in_maintenance() | invalid_input() | unsupported_t_l_d()

  @type delete_domain_errors() ::
          t_l_d_rules_violation() | invalid_input() | unsupported_t_l_d() | duplicate_request()
  ...
  @type enable_domain_auto_renew_errors() ::
          t_l_d_rules_violation() | invalid_input() | unsupported_t_l_d()
  ...
  @type transfer_domain_to_another_aws_account_errors() ::
          operation_limit_exceeded() | invalid_input() | unsupported_t_l_d() | duplicate_request()
