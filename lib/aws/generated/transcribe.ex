...
defmodule AWS.Transcribe do
  ...
  **Call Analytics transcriptions** are designed
  ...
  """
  @type delete_call_analytics_job_response() :: %{String.t() => any()}
  ...
  """
  @type delete_call_analytics_category_response() :: %{String.t() => any()}
  ...
  """
  @type delete_medical_transcription_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_language_model_request() :: %{String.t() => any()}
  ...
  """
  @type get_call_analytics_job_request() :: %{String.t() => any()}
  ...
  """
  @type get_vocabulary_request() :: %{String.t() => any()}
  ...
  """
  @type get_transcription_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_medical_scribe_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_transcription_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_call_analytics_job_request() :: %{String.t() => any()}
  ...
  """
  @type get_medical_scribe_job_request() :: %{String.t() => any()}
  ...
  """
  @type get_medical_transcription_job_request() :: %{String.t() => any()}
  ...
  """
  @type delete_vocabulary_filter_request() :: %{String.t() => any()}
  ...
  """
  @type describe_language_model_request() :: %{String.t() => any()}
  ...
  """
  @type delete_medical_vocabulary_request() :: %{String.t() => any()}
  ...
  """
  @type get_call_analytics_category_request() :: %{String.t() => any()}
  ...
  """
  @type get_medical_vocabulary_request() :: %{String.t() => any()}
  ...
  """
  @type get_vocabulary_filter_request() :: %{String.t() => any()}
  ...
  """
  @type delete_call_analytics_category_request() :: %{String.t() => any()}
