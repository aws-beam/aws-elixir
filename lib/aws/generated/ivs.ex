...
defmodule AWS.Ivs do
  ...
  * **All API request parameters and URLs are case sensitive. ** *
  ...
  create a channel, which is then used to authorize streaming. * **Treat the
  ...
  channels can reference the same recording configuration.
  ...
  set a tag as `topic:nature` to label a particular video category. See [Best practices and
  ...
  """
  @type import_playback_key_pair_response() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_recording_configurations_request() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      video_configuration() :: %{
        "avcLevel" => String.t() | atom(),
        "avcProfile" => String.t() | atom(),
        "codec" => String.t() | atom(),
        "encoder" => String.t() | atom(),
        "level" => String.t() | atom(),
  ...
  ## Example:
      ...
      channel_summary() :: %{
        "adConfigurationArn" => String.t() | atom(),
        "arn" => String.t() | atom(),
        "authorized" => boolean(),
        "insecureIngest" => boolean(),
        "latencyMode" => String.t() | atom(),
        "name" => String.t() | atom(),
        "playbackRestrictionPolicyArn" => String.t() | atom(),
        "preset" => list(any()),
        "recordingConfigurationArn" => String.t() | atom(),
        "tags" => map(),
        "type" => list(any())
      }
  ...
  ## Example:
      ...
      create_ad_configuration_request() :: %{
        ...
        optional("name") => String.t() | atom(),
        optional("postRollConfiguration") => post_roll_configuration(),
        optional("tags") => map()
      }

  """
  @type create_ad_configuration_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type delete_recording_configuration_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type post_roll_configuration() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type batch_start_viewer_session_revocation_response() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type playback_restriction_policy() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      channel() :: %{
        ...
        "arn" => String.t() | atom(),
        "authorized" => boolean(),
        "containerFormat" => String.t() | atom(),
        "ingestEndpoint" => String.t() | atom(),
        "insecureIngest" => boolean(),
        "latencyMode" => String.t() | atom(),
  ...
  @type batch_get_channel_errors() ::
          access_denied_exception() | validation_exception() | service_unavailable()
  ...
  @type get_channel_errors() ::
          access_denied_exception() | validation_exception() | resource_not_found_exception()
  ...
  @type list_channels_errors() ::
          access_denied_exception() | validation_exception() | conflict_exception()

  @type list_playback_key_pairs_errors() :: access_denied_exception() | validation_exception()
  ...
  @type list_streams_errors() :: access_denied_exception() | validation_exception()
  ...
  @spec batch_get_channel(map(), batch_get_channel_request(), list()) ::
          ...
          | {:error, term()}
          | {:error, batch_get_channel_errors()}
  ...
  @spec batch_get_stream_key(map(), batch_get_stream_key_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, batch_get_stream_key_errors()}
  ...
  """
  @spec create_ad_configuration(map(), create_ad_configuration_request(), list()) ::
          {:ok, create_ad_configuration_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, create_ad_configuration_errors()}
  def create_ad_configuration(%Client{} = client, input, options \\ []) do
    url_path = "/CreateAdConfiguration"
    headers = []
    custom_headers = []
    query_params = []
  ...
  **Workaround:** Ensure that your S3 bucket is in the same region as the
  ...
  """
  @spec delete_ad_configuration(map(), delete_ad_configuration_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, delete_ad_configuration_errors()}
  def delete_ad_configuration(%Client{} = client, input, options \\ []) do
    url_path = "/DeleteAdConfiguration"
    headers = []
    custom_headers = []
    query_params = []
  ...
  """
  @spec get_ad_configuration(map(), get_ad_configuration_request(), list()) ::
          {:ok, get_ad_configuration_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, get_ad_configuration_errors()}
  def get_ad_configuration(%Client{} = client, input, options \\ []) do
    url_path = "/GetAdConfiguration"
    headers = []
    custom_headers = []
    query_params = []
  ...
  **Note:** AWS Elemental MediaTailor (EMT), the service that handles ad requests,
  ...
  InsertAdBreak operation. See [Monitoring AWS Elemental MediaTailor with Amazon CloudWatch](https://docs.aws.amazon.com/mediatailor/latest/ug/monitoring-cloudwatch-metrics.html)
  metrics in the *AWS Elemental MediaTailor User Guide* for details on available
  metrics.
  """
  @spec insert_ad_break(map(), insert_ad_break_request(), list()) ::
          {:ok, insert_ad_break_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, insert_ad_break_errors()}
  def insert_ad_break(%Client{} = client, input, options \\ []) do
    url_path = "/InsertAdBreak"
    headers = []
    custom_headers = []
    query_params = []
  ...
  @doc """
  Gets summary information about all ad configurations in your account, in the AWS
  region where the API request is processed.
  """
  @spec list_ad_configurations(map(), list_ad_configurations_request(), list()) ::
          {:ok, list_ad_configurations_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, list_ad_configurations_errors()}
  def list_ad_configurations(%Client{} = client, input, options \\ []) do
    url_path = "/ListAdConfigurations"
    headers = []
    custom_headers = []
    query_params = []
