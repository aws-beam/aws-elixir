...
defmodule AWS.TrustedAdvisor do
  ...
  ## Example:
      ...
      check_summary() :: %{
        "arn" => String.t() | atom(),
        "awsResourceTypes" => list([String.t() | atom()]()),
        "awsServices" => list(String.t() | atom()),
        "checkGranularity" => [String.t() | atom()],
  ...
  ## Example:
      ...
      list_recommendations_for_resource_request() :: %{
        optional("checkArn") => String.t() | atom(),
        optional("language") => list(any()),
        optional("maxResults") => [integer()],
        optional("nextToken") => [String.t() | atom()],
        optional("pillar") => list(any()),
  ...
  """
  @type list_recommendations_for_resource_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type list_recommendations_for_resource_response() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type recommendation_for_resource_summary() :: %{(String.t() | atom()) => any()}
  ...
  """
  @spec list_recommendations_for_resource(
          map(),
          String.t() | atom(),
          String.t() | atom() | nil,
          String.t() | atom() | nil,
          ...
          {:ok, list_recommendations_for_resource_response(), any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
          | {:error, list_recommendations_for_resource_errors()}
  def list_recommendations_for_resource(
    ...
    url_path = "/v1/recommendations-for-resource/#{AWS.Util.encode_uri(aws_resource_arn)}"
    headers = []
    query_params = []

    query_params =
      if !is_nil(check_arn) do
        [{"checkArn", check_arn} | query_params]
      else
        query_params
      end
