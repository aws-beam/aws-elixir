...
defmodule AWS.EventBridge do
  ...
  @type create_endpoint_errors() ::
          internal_exception() | resource_already_exists_exception() | limit_exceeded_exception()
  ...
  @type describe_event_source_errors() ::
          resource_not_found_exception() | internal_exception() | operation_disabled_exception()
