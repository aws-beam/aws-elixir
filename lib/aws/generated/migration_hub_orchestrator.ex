...
defmodule AWS.MigrationHubOrchestrator do
  ...
  """
  @type start_migration_workflow_request() :: %{String.t() => any()}
  ...
  """
  @type stop_migration_workflow_request() :: %{String.t() => any()}
  ...
  """
  @type delete_migration_workflow_request() :: %{String.t() => any()}
  ...
  """
  @type get_migration_workflow_template_request() :: %{String.t() => any()}
  ...
  """
  @type delete_workflow_step_response() :: %{String.t() => any()}
  ...
  """
  @type get_migration_workflow_request() :: %{String.t() => any()}
  ...
  """
  @type get_template_step_group_request() :: %{String.t() => any()}
  ...
  """
  @type delete_workflow_step_group_response() :: %{String.t() => any()}
