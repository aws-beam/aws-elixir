...
defmodule AWS.QLDBSession do
  ...
  """
  @type abort_transaction_request() :: %{String.t() => any()}
  ...
  """
  @type end_session_request() :: %{String.t() => any()}
  ...
  @spec send_command(map(), send_command_request(), list()) ::
          ...
          | {:error, capacity_exceeded_exception()}
          | {:error, invalid_session_exception()}
          | {:error, limit_exceeded_exception()}
          | {:error, occ_conflict_exception()}
          | {:error, rate_exceeded_exception()}
