...
defmodule AWS.DatabaseMigration do
  ...
  """
  @type delete_replication_subnet_group_response() :: %{String.t() => any()}
  ...
  @spec create_data_provider(map(), create_data_provider_message(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, access_denied_fault()}
          | {:error, resource_already_exists_fault()}
          | {:error, resource_quota_exceeded_fault()}
  ...
  @spec create_event_subscription(map(), create_event_subscription_message(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, kms_access_denied_fault()}
          | {:error, kms_disabled_fault()}
          | {:error, kms_invalid_state_fault()}
          | {:error, kms_not_found_fault()}
          | {:error, kms_throttling_fault()}
          | {:error, resource_already_exists_fault()}
          | {:error, resource_not_found_fault()}
          | {:error, resource_quota_exceeded_fault()}
  ...
  @spec create_fleet_advisor_collector(map(), create_fleet_advisor_collector_request(), list()) ::
          ...
          | {:error, resource_quota_exceeded_fault()}
          | {:error, s3_access_denied_fault()}
          | {:error, s3_resource_not_found_fault()}
  ...
  @spec create_replication_config(map(), create_replication_config_message(), list()) ::
          ...
          | {:error, kms_key_not_accessible_fault()}
          | {:error, replication_subnet_group_does_not_cover_enough_a_zs()}
          | {:error, resource_already_exists_fault()}
          | {:error, resource_not_found_fault()}
          | {:error, resource_quota_exceeded_fault()}
  ...
  @spec create_replication_instance(map(), create_replication_instance_message(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, access_denied_fault()}
          | {:error, insufficient_resource_capacity_fault()}
          | {:error, invalid_resource_state_fault()}
          | {:error, invalid_subnet()}
          | {:error, kms_key_not_accessible_fault()}
          | {:error, replication_subnet_group_does_not_cover_enough_a_zs()}
  ...
  @spec delete_fleet_advisor_collector(map(), delete_collector_request(), list()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
          | {:error, collector_not_found_fault()}
          | {:error, invalid_resource_state_fault()}
  ...
  @spec import_certificate(map(), import_certificate_message(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, invalid_certificate_fault()}
          | {:error, resource_already_exists_fault()}
          | {:error, resource_quota_exceeded_fault()}
  ...
  @spec modify_replication_instance(map(), modify_replication_instance_message(), list()) ::
          ...
          | {:error, resource_not_found_fault()}
          | {:error, storage_quota_exceeded_fault()}
          | {:error, upgrade_dependency_failure_fault()}
