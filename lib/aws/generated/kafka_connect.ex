...
defmodule AWS.KafkaConnect do
  ...
  """
  @type delete_custom_plugin_request() :: %{String.t() => any()}
  ...
  """
  @type describe_custom_plugin_request() :: %{String.t() => any()}
  ...
  """
  @type delete_worker_configuration_request() :: %{String.t() => any()}
  ...
  """
  @type describe_worker_configuration_request() :: %{String.t() => any()}
