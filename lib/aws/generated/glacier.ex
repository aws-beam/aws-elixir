...
defmodule AWS.Glacier do
  ...
  ## Example:
      ...
      initiate_job_output() :: %{
        ...
        "jobOutputPath" => String.t() | Atom.t(),
        "location" => String.t() | Atom.t()
      }

  """
  @type initiate_job_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type remove_tags_from_vault_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_vault_access_policy_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_tags_for_vault_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type set_vault_access_policy_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type data_retrieval_rule() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      upload_archive_input() :: %{
        optional("archiveDescription") => String.t() | Atom.t(),
        optional("body") => binary(),
        optional("checksum") => String.t() | Atom.t()
      }

  """
  @type upload_archive_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_provisioned_capacity_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type vault_access_policy() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type initiate_job_input() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      inventory_retrieval_job_description() :: %{
        ...
        "Limit" => String.t() | Atom.t(),
        "Marker" => String.t() | Atom.t(),
        "StartDate" => String.t() | Atom.t()
      }

  """
  @type inventory_retrieval_job_description() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type create_vault_output() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      job_parameters() :: %{
        ...
        "RetrievalByteRange" => String.t() | Atom.t(),
  ...
  """
  @type job_parameters() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      complete_multipart_upload_input() :: %{
        optional("archiveSize") => String.t() | Atom.t(),
        optional("checksum") => String.t() | Atom.t()
      }

  """
  @type complete_multipart_upload_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type set_vault_notifications_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type data_retrieval_policy() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      part_list_element() :: %{
        "RangeInBytes" => String.t() | Atom.t(),
        "SHA256TreeHash" => String.t() | Atom.t()
      }

  """
  @type part_list_element() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_vault_notifications_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_vaults_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_job_output_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type archive_creation_output() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      upload_list_element() :: %{
        "ArchiveDescription" => String.t() | Atom.t(),
        "CreationDate" => String.t() | Atom.t(),
        "MultipartUploadId" => String.t() | Atom.t(),
        "PartSizeInBytes" => float(),
        "VaultARN" => String.t() | Atom.t()
      }

  """
  @type upload_list_element() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type upload_multipart_part_input() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      initiate_multipart_upload_input() :: %{
        optional("archiveDescription") => String.t() | Atom.t(),
        optional("partSize") => String.t() | Atom.t()
      }

  """
  @type initiate_multipart_upload_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type set_data_retrieval_policy_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_vaults_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type vault_lock_policy() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type policy_enforced_exception() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_jobs_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type upload_multipart_part_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type initiate_vault_lock_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type purchase_provisioned_capacity_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type vault_notification_config() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      glacier_job_description() :: %{
        "Action" => list(any()),
        "ArchiveId" => String.t() | Atom.t(),
        "ArchiveSHA256TreeHash" => String.t() | Atom.t(),
  ...
  """
  @type glacier_job_description() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      list_jobs_input() :: %{
        optional("completed") => String.t() | Atom.t(),
        optional("limit") => [integer()],
        optional("marker") => String.t() | Atom.t(),
  ...
  """
  @type list_jobs_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_parts_input() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      initiate_vault_lock_output() :: %{
        "lockId" => String.t() | Atom.t()
      }

  """
  @type initiate_vault_lock_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type inventory_retrieval_job_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_job_output_output() :: %{String.t() | Atom.t() => any()}
  ...
  ## Example:
      ...
      describe_vault_output() :: %{
        "CreationDate" => String.t() | Atom.t(),
        "LastInventoryDate" => String.t() | Atom.t(),
        "NumberOfArchives" => float(),
        "SizeInBytes" => float(),
        "VaultARN" => String.t() | Atom.t(),
        "VaultName" => String.t() | Atom.t()
      }

  """
  @type describe_vault_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type initiate_multipart_upload_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type add_tags_to_vault_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type list_multipart_uploads_input() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_vault_lock_output() :: %{String.t() | Atom.t() => any()}
  ...
  """
  @type get_data_retrieval_policy_output() :: %{String.t() | Atom.t() => any()}
  ...
  *Amazon Glacier Developer Guide*.
  """
  @spec describe_vault(map(), String.t() | Atom.t(), String.t() | Atom.t(), list()) ::
  ...
  """
  @spec get_data_retrieval_policy(map(), String.t() | Atom.t(), list()) ::
  ...
  **Get Job Output** response.
  ...
  """
  @spec get_vault_access_policy(map(), String.t() | Atom.t(), String.t() | Atom.t(), list()) ::
  ...
  Policies](https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-lock-policy.html).
  """
  @spec get_vault_lock(map(), String.t() | Atom.t(), String.t() | Atom.t(), list()) ::
  ...
  in the *Amazon Glacier Developer Guide*.
  """
  @spec get_vault_notifications(map(), String.t() | Atom.t(), String.t() | Atom.t(), list()) ::
  ...
  *Amazon Glacier Developer Guide*.
  ...
  account.
  """
  @spec list_provisioned_capacity(map(), String.t() | Atom.t(), list()) ::
  ...
  Resources](https://docs.aws.amazon.com/amazonglacier/latest/dev/tagging.html).
  """
  @spec list_tags_for_vault(map(), String.t() | Atom.t(), String.t() | Atom.t(), list()) ::
