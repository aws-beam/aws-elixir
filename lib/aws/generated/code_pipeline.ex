...
defmodule AWS.CodePipeline do
  ...
  **Third party jobs**, which are instances of an action
  ...
  @type deregister_webhook_with_third_party_errors() ::
          validation_exception() | webhook_not_found_exception()

  @type disable_stage_transition_errors() ::
          pipeline_not_found_exception() | stage_not_found_exception() | validation_exception()
  ...
  @type put_job_failure_result_errors() ::
          invalid_job_state_exception() | validation_exception() | job_not_found_exception()
  ...
  @type update_action_type_errors() ::
          request_failed_exception() | validation_exception() | action_type_not_found_exception()
