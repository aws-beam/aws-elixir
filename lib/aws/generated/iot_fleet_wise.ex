...
defmodule AWS.IoTFleetWise do
  ...
  *Amazon Web Services IoT FleetWise Developer Guide*.
  ...
  """
  @type get_register_account_status_request() :: %{String.t() => any()}
  ...
  """
  @type delete_model_manifest_request() :: %{String.t() => any()}
  ...
  """
  @type get_vehicle_request() :: %{String.t() => any()}
  ...
  """
  @type get_encryption_configuration_request() :: %{String.t() => any()}
  ...
  """
  @type disassociate_vehicle_fleet_response() :: %{String.t() => any()}
  ...
  """
  @type get_fleet_request() :: %{String.t() => any()}
  ...
  """
  @type delete_decoder_manifest_request() :: %{String.t() => any()}
  ...
  """
  @type delete_vehicle_request() :: %{String.t() => any()}
  ...
  """
  @type get_decoder_manifest_request() :: %{String.t() => any()}
  ...
  """
  @type associate_vehicle_fleet_response() :: %{String.t() => any()}
  ...
  """
  @type get_signal_catalog_request() :: %{String.t() => any()}
  ...
  """
  @type get_model_manifest_request() :: %{String.t() => any()}
  ...
  """
  @type delete_signal_catalog_request() :: %{String.t() => any()}
  ...
  @spec create_decoder_manifest(map(), create_decoder_manifest_request(), list()) ::
          ...
          | {:error, access_denied_exception()}
          | {:error, conflict_exception()}
          | {:error, decoder_manifest_validation_exception()}
          | {:error, limit_exceeded_exception()}
          | {:error, resource_not_found_exception()}
          | {:error, throttling_exception()}
          | {:error, validation_exception()}
  ...
  *Amazon Web Services IoT FleetWise Developer Guide*.
  ...
  @spec create_model_manifest(map(), create_model_manifest_request(), list()) ::
          ...
          | {:error, access_denied_exception()}
          | {:error, conflict_exception()}
          | {:error, invalid_signals_exception()}
          | {:error, limit_exceeded_exception()}
          | {:error, resource_not_found_exception()}
          | {:error, throttling_exception()}
          | {:error, validation_exception()}
