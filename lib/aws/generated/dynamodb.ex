...
defmodule AWS.DynamoDB do
  ...
  @type batch_execute_statement_errors() ::
          throttling_exception() | internal_server_error() | request_limit_exceeded()
  ...
  @type describe_continuous_backups_errors() ::
          internal_server_error() | table_not_found_exception() | invalid_endpoint_exception()

  @type describe_contributor_insights_errors() ::
          resource_not_found_exception() | internal_server_error()

  @type describe_export_errors() ::
          internal_server_error() | limit_exceeded_exception() | export_not_found_exception()
  ...
  @type import_table_errors() ::
          import_conflict_exception() | limit_exceeded_exception() | resource_in_use_exception()
