...
defmodule AWS.ElasticBeanstalk do
  ...
  @type compose_environments_errors() ::
          too_many_environments_exception() | insufficient_privileges_exception()
  ...
  @type describe_environment_health_errors() ::
          elastic_beanstalk_service_exception() | invalid_request_exception()
  ...
  @type describe_platform_version_errors() ::
          elastic_beanstalk_service_exception() | insufficient_privileges_exception()
  ...
  @type update_configuration_template_errors() ::
          too_many_buckets_exception() | insufficient_privileges_exception()
