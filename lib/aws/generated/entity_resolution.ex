...
defmodule AWS.EntityResolution do
  ...
  def add_policy_statement(%Client{} = client, statement_id, arn, input, options \\ []) do
  ...
  def delete_policy_statement(%Client{} = client, statement_id, arn, input, options \\ []) do
    url_path = "/policies/#{AWS.Util.encode_uri(arn)}/#{AWS.Util.encode_uri(statement_id)}"
    headers = []
    custom_headers = []
    query_params = []
  ...
  def get_id_mapping_job(%Client{} = client, workflow_name, job_id, options \\ []) do
    url_path =
  ...
  def get_matching_job(%Client{} = client, workflow_name, job_id, options \\ []) do
    url_path =
  ...
  def list_id_namespaces(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
    url_path = "/idnamespaces"
    headers = []
    query_params = []
