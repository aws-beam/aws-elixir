...
defmodule AWS.Mgn do
  ...
  @type create_launch_configuration_template_errors() ::
          uninitialized_account_exception() | access_denied_exception() | validation_exception()
  ...
  @type delete_network_migration_definition_errors() ::
          resource_not_found_exception() | conflict_exception() | access_denied_exception()
  ...
  @type get_network_migration_mapper_segment_construct_errors() ::
          resource_not_found_exception() | access_denied_exception() | validation_exception()

  @type get_replication_configuration_errors() ::
          uninitialized_account_exception() | resource_not_found_exception()

  @type initialize_service_errors() :: access_denied_exception() | validation_exception()
