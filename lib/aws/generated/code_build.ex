...
defmodule AWS.CodeBuild do
  ...
  ## Example:
      ...
      start_build_input() :: %{
        ...
        optional("insecureSslOverride") => boolean(),
        optional("sourceVersion") => String.t() | atom(),
        optional("hostKernelOverride") => list(any()),
        optional("buildspecOverride") => String.t() | atom(),
        optional("secondaryArtifactsOverride") => list(project_artifacts()),
  ...
  @type delete_webhook_errors() ::
          resource_not_found_exception() | invalid_input_exception() | o_auth_provider_exception()

  @type describe_code_coverages_errors() :: invalid_input_exception()

  @type describe_test_cases_errors() :: resource_not_found_exception() | invalid_input_exception()

  @type get_report_group_trend_errors() ::
          resource_not_found_exception() | invalid_input_exception()

  @type get_resource_policy_errors() :: resource_not_found_exception() | invalid_input_exception()
  ...
  @type put_resource_policy_errors() :: resource_not_found_exception() | invalid_input_exception()
  ...
  @type retry_build_batch_errors() :: resource_not_found_exception() | invalid_input_exception()
  ...
  @type start_build_batch_errors() :: resource_not_found_exception() | invalid_input_exception()
  ...
  @type stop_build_errors() :: resource_not_found_exception() | invalid_input_exception()

  @type stop_build_batch_errors() :: resource_not_found_exception() | invalid_input_exception()

  @type stop_sandbox_errors() :: resource_not_found_exception() | invalid_input_exception()
  ...
  @type update_project_errors() :: resource_not_found_exception() | invalid_input_exception()

  @type update_project_visibility_errors() ::
          resource_not_found_exception() | invalid_input_exception()

  @type update_report_group_errors() :: resource_not_found_exception() | invalid_input_exception()
