...
defmodule AWS.CloudFormation do
  ...
  For more information on stack and resource drift, see [Detecting
  ...
  `DescribeStackResourceDrifts` to return drift information about the stack
  and its resources.
  """
  ...
  drift detection are not checked, and so not included. For a list of
  ...
  specific type version. Otherwise, it returns information about the default
  type version.
  """
  ...
  information, see [Detecting Unregulated Configuration Changes to Stacks and
  Resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html).
  ...
  about stack and resource drift, see [Detecting Unregulated Configuration
  Changes to Stacks and
  Resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html).
  ...
  each stack instance in the stack set. For more information, see [How
  CloudFormation Performs Drift Detection on a Stack
  ...
  </li> <li> Use ` `ListStackInstances` ` to return a list of stack instances
  ...
  on a stack set, see [Detecting Unmanaged Changes in Stack
  ...
  </li> </ul> For more information on how to develop types and ready them for
  ...
  defp request(client, action, input, options) do
    ...
    host = get_host("cloudformation", client)
    ...
    input = %{ input
               | "Action" => action, "Version" => "2010-05-15"
             }
