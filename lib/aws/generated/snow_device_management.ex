...
defmodule AWS.SnowDeviceManagement do
  ...
  """
  @type describe_device_input() :: %{String.t() => any()}
  ...
  """
  @type describe_task_input() :: %{String.t() => any()}
  ...
  """
  @type cancel_task_input() :: %{String.t() => any()}
