...
defmodule AWS.Budgets do
  ...
  **RI coverage budgets** - Define a coverage threshold, and receive alerts when
  ...
  """
  @type delete_budget_response() :: %{String.t() => any()}
  ...
  """
  @type create_notification_response() :: %{String.t() => any()}
  ...
  """
  @type update_budget_response() :: %{String.t() => any()}
  ...
  """
  @type delete_notification_response() :: %{String.t() => any()}
  ...
  """
  @type update_notification_response() :: %{String.t() => any()}
  ...
  @spec create_budget(map(), create_budget_request(), list()) ::
          ...
          | {:error, creation_limit_exceeded_exception()}
          | {:error, duplicate_record_exception()}
  ...
  @spec delete_budget_action(map(), delete_budget_action_request(), list()) ::
          ...
          | {:error, invalid_parameter_exception()}
          | {:error, not_found_exception()}
          | {:error, resource_locked_exception()}
          | {:error, throttling_exception()}
