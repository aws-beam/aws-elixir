...
defmodule AWS.IoTEvents do
  ...
  """
  @type delete_alarm_model_request() :: %{String.t() => any()}
  ...
  """
  @type delete_alarm_model_response() :: %{String.t() => any()}
  ...
  """
  @type delete_detector_model_response() :: %{String.t() => any()}
  ...
  """
  @type delete_detector_model_request() :: %{String.t() => any()}
  ...
  """
  @type describe_detector_model_analysis_request() :: %{String.t() => any()}
