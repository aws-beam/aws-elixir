...
defmodule AWS.IoTAnalytics do
  ...
  """
  @type json_configuration() :: %{String.t() => any()}
  ...
  """
  @type cancel_pipeline_reprocessing_response() :: %{String.t() => any()}
  ...
  """
  @type service_managed_channel_s3_storage_summary() :: %{String.t() => any()}
  ...
  """
  @type service_managed_channel_s3_storage() :: %{String.t() => any()}
  ...
  """
  @type service_managed_datastore_s3_storage_summary() :: %{String.t() => any()}
  ...
  """
  @type service_managed_datastore_s3_storage() :: %{String.t() => any()}
  ...
  """
  @type cancel_pipeline_reprocessing_request() :: %{String.t() => any()}
  ...
  """
  @type delete_datastore_request() :: %{String.t() => any()}
