...
defmodule AWS.EKS do
  ...
  @type delete_access_entry_errors() ::
          resource_not_found_exception() | invalid_request_exception() | server_exception()
  ...
  @type describe_addon_configuration_errors() ::
          invalid_parameter_exception() | resource_not_found_exception() | server_exception()
  ...
  @type list_tags_for_resource_errors() :: not_found_exception() | bad_request_exception()
  ...
  @type tag_resource_errors() :: not_found_exception() | bad_request_exception()

  @type untag_resource_errors() :: not_found_exception() | bad_request_exception()
  ...
  def cancel_update(%Client{} = client, update_id, name, input, options \\ []) do
    url_path =
  ...
  *Amazon EKS User Guide*.
  ...
  `ipFamily` for the cluster. For more information, see [Amazon EKS Cluster Endpoint Access
  ...
  *.
  ...
  Additionally, you can configure a role for EKS Pod Identity once, and reuse it
  across
  clusters.
  ...
  role assumptions in sequence: first assuming the role in the association that is
  in this
  account, then using those credentials to assume the target IAM role. This
  process
  provides your Pod with temporary credentials that have the permissions defined
  in the
  target role, allowing secure access to resources in another Amazon Web Services
  account.
  """
  ...
  def delete_access_entry(%Client{} = client, principal_arn, cluster_name, input, options \\ []) do
    url_path =
  ...
  def delete_addon(%Client{} = client, cluster_name, addon_name, input, options \\ []) do
    url_path =
  ...
  def delete_capability(%Client{} = client, cluster_name, capability_name, input, options \\ []) do
    url_path =
  ...
  def delete_nodegroup(%Client{} = client, nodegroup_name, cluster_name, input, options \\ []) do
    url_path =
  ...
  def describe_access_entry(%Client{} = client, principal_arn, cluster_name, options \\ []) do
    url_path =
      "/clusters/#{AWS.Util.encode_uri(cluster_name)}/access-entries/#{AWS.Util.encode_uri(principal_arn)}"
  ...
  def describe_addon(%Client{} = client, cluster_name, addon_name, options \\ []) do
    url_path =
      "/clusters/#{AWS.Util.encode_uri(cluster_name)}/addons/#{AWS.Util.encode_uri(addon_name)}"
  ...
  def describe_addon_configuration(%Client{} = client, addon_version, addon_name, options \\ []) do
  ...
  def describe_capability(%Client{} = client, cluster_name, capability_name, options \\ []) do
    url_path =
      "/clusters/#{AWS.Util.encode_uri(cluster_name)}/capabilities/#{AWS.Util.encode_uri(capability_name)}"
  ...
  def describe_insight(%Client{} = client, id, cluster_name, options \\ []) do
    url_path =
  ...
  def describe_nodegroup(%Client{} = client, nodegroup_name, cluster_name, options \\ []) do
    url_path =
      "/clusters/#{AWS.Util.encode_uri(cluster_name)}/node-groups/#{AWS.Util.encode_uri(nodegroup_name)}"
  ...
  def update_access_entry(%Client{} = client, principal_arn, cluster_name, input, options \\ []) do
    url_path =
      "/clusters/#{AWS.Util.encode_uri(cluster_name)}/access-entries/#{AWS.Util.encode_uri(principal_arn)}"
  ...
  def update_addon(%Client{} = client, cluster_name, addon_name, input, options \\ []) do
    url_path =
  ...
  def update_capability(%Client{} = client, cluster_name, capability_name, input, options \\ []) do
    url_path =
      "/clusters/#{AWS.Util.encode_uri(cluster_name)}/capabilities/#{AWS.Util.encode_uri(capability_name)}"
