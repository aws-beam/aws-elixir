...
defmodule AWS.Connect do
  ...
  *Connect Customer Administrator Guide*.
  ...
  ## Important things to know
    ...
    *
  Use this API with chat, email, task, and voice contacts. For voice callbacks,
  this API does not support customer-first mode.
  ...
  **This deletion is permanent and cannot be undone.** Performing this
  ...
  def delete_contact_data(%Client{} = client, contact_id, instance_id, input, options \\ []) do
    url_path =
  ...
  *Connect Customer Administrator Guide*.
  ...
  def delete_session(%Client{} = client, instance_id, session_id, input, options \\ []) do
    url_path =
