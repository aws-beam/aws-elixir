...
defmodule AWS.XRay do
  ...
  """
  @type put_telemetry_records_result() :: %{String.t() => any()}
  ...
  """
  @type delete_group_result() :: %{String.t() => any()}
  ...
  """
  @type get_encryption_config_request() :: %{String.t() => any()}
  ...
  @spec create_sampling_rule(map(), create_sampling_rule_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, invalid_request_exception()}
          | {:error, rule_limit_exceeded_exception()}
          | {:error, throttled_exception()}
  ...
  @spec put_resource_policy(map(), put_resource_policy_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, invalid_policy_revision_id_exception()}
          | {:error, lockout_prevention_exception()}
          | {:error, malformed_policy_document_exception()}
          | {:error, policy_count_limit_exceeded_exception()}
          | {:error, policy_size_limit_exceeded_exception()}
          | {:error, throttled_exception()}
