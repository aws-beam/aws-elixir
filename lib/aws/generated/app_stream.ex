...
defmodule AWS.AppStream do
  ...
  ## Example:
      ...
      create_app_block_builder_request() :: %{
        ...
        optional("DisableIMDSV1") => boolean(),
  ...
  @type batch_associate_user_stack_errors() ::
          invalid_parameter_combination_exception() | operation_not_permitted_exception()
  ...
  @type delete_image_permissions_errors() ::
          resource_not_available_exception() | resource_not_found_exception()
  ...
  @type describe_images_errors() ::
          invalid_parameter_combination_exception() | resource_not_found_exception()
