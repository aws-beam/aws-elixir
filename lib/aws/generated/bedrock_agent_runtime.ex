...
defmodule AWS.BedrockAgentRuntime do
  ...
  def delete_agent_memory(%Client{} = client, agent_id, agent_alias_id, input, options \\ []) do
    url_path =
  ...
  def invoke_agent(%Client{} = client, session_id, agent_id, agent_alias_id, input, options \\ []) do
    url_path =
