...
defmodule AWS.GeoPlaces do
  ...
  Key features include:
    ...
    * Forward and reverse geocoding for addresses and coordinates. See
  [Geocode](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_Geocode.html) and
  [ReverseGeocode](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_ReverseGeocode.html).

    * Comprehensive place searches with detailed information. See
  [SearchText](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_SearchText.html), [SearchNearby](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_SearchNearby.html),
  and
  [GetPlace](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_GetPlace.html). Place information you can find include:
    ...
    * Address and place completion as users type, enhancing input
  efficiency by completing partial queries with valid addresses. See
  [Autocomplete](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_Autocomplete.html).

    * Intelligent place and query recommendation based on user's input
  or context, returning relevant places, points of interest, query terms, or
  search categories. See
  [Suggest](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_Suggest.html).     * Global data coverage with a wide range of POI categories.

    * Regular data updates to ensure accuracy and relevance.

    * Bulk address validation for verifying and standardizing large
  volumes of addresses in a single operation using [Amazon Location Service
  Jobs](https://docs.aws.amazon.com/location/latest/APIReference/Welcome.html#Welcome_Amazon_Location_Service_Jobs).
  """
  ...
  ## Example:
      ...
      translation_details() :: %{
        "District" => list(admin_names()),
        "Locality" => list(admin_names()),
        "Region" => list(admin_names()),
        "SubRegion" => list(admin_names())
      }

  """
  @type translation_details() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type translation_name() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      postal_code_details() :: %{
        "PostalAuthority" => list(any()),
        "PostalCode" => String.t() | atom(),
        "PostalCodeType" => list(any()),
        "UspsZip" => usps_zip(),
  ...
  ## Example:
      ...
      geocode_filter() :: %{
        ...
        "IncludePlaceTypes" => list(list(any())())
      }
  ...
  ## Example:
      ...
      suggest_result_item() :: %{
        ...
        "SuggestResultItemType" => list(any()),
        "Title" => String.t() | atom()
      }
  ...
  ## Example:
      ...
      get_place_request() :: %{
        ...
        optional("AddressNamesMode") => list(any()),
        optional("IntendedUse") => list(any()),
  ...
  ## Example:
      ...
      usps_zip() :: %{
        "ZipClassificationCode" => list(any())
      }
  ...
  ## Example:
      ...
      autocomplete_request() :: %{
        ...
        optional("MaxResults") => [integer()],
        optional("PoliticalView") => String.t() | atom(),
        optional("PostalCodeMode") => list(any()),
  ...
  ## Example:
      ...
      geocode_request() :: %{
        optional("AdditionalFeatures") => list(list(any())()),
        optional("AddressNamesMode") => list(any()),
        optional("AddressTranslations") => list(list(any())()),
        optional("BiasPosition") => list([float()]()),
  ...
  ## Example:
      ...
      geocode_parsed_query_address_components() :: %{
        ...
        "OtherComponents" => list(parsed_query_component()),
  ...
  ## Example:
      ...
      admin_names() :: %{
        "Names" => list(translation_name()),
        "Preference" => list(any())
      }

  """
  @type admin_names() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      cross_reference() :: %{
        ...
        "SourcePlaceId" => String.t() | atom()
      }

  """
  @type cross_reference() :: %{(String.t() | atom()) => any()}
  ...
  tailored using optional parameters like language and political views. Not
  ...
  def get_place(
    ...
    query_params =
      if !is_nil(address_names_mode) do
        [{"address-names-mode", address_names_mode} | query_params]
      else
        query_params
      end
  ...
  more based on requested parameters. Not supported in `ap-southeast-1` and
  `ap-southeast-5` regions for
  [GrabMaps](https://docs.aws.amazon.com/location/latest/developerguide/GrabMaps.html) customers.

  For more information, see [Search
  Nearby](https://docs.aws.amazon.com/location/latest/developerguide/search-nearby.html)
  in the *Amazon Location Service Developer Guide*.
  """
