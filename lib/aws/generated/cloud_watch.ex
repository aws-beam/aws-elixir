...
defmodule AWS.CloudWatch do
  ...
  """
  @type delete_dashboards_output() :: %{String.t() => any()}
  ...
  """
  @type put_insight_rule_output() :: %{String.t() => any()}
  ...
  """
  @type stop_metric_streams_output() :: %{String.t() => any()}
  ...
  """
  @type start_metric_streams_output() :: %{String.t() => any()}
  ...
  """
  @type delete_anomaly_detector_output() :: %{String.t() => any()}
  ...
  """
  @type delete_metric_stream_output() :: %{String.t() => any()}
  ...
  """
  @type put_anomaly_detector_output() :: %{String.t() => any()}
  ...
  @spec delete_dashboards(map(), delete_dashboards_input(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, dashboard_not_found_error()}
          | {:error, internal_service_fault()}
          | {:error, invalid_parameter_value_exception()}
  ...
  *Amazon CloudWatch User Guide*.
  ...
  @spec put_dashboard(map(), put_dashboard_input(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, dashboard_invalid_input_error()}
          | {:error, internal_service_fault()}
