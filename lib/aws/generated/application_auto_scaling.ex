...
defmodule AWS.ApplicationAutoScaling do
  ...
  """
  @type put_scheduled_action_response() :: %{String.t() => any()}
  ...
  """
  @type delete_scaling_policy_response() :: %{String.t() => any()}
  ...
  """
  @type deregister_scalable_target_response() :: %{String.t() => any()}
  ...
  *Application Auto Scaling User Guide*.
  ...
  @spec delete_scaling_policy(map(), delete_scaling_policy_request(), list()) ::
          ...
          | {:error, concurrent_update_exception()}
  ...
  @spec describe_scaling_policies(map(), describe_scaling_policies_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, concurrent_update_exception()}
          | {:error, failed_resource_access_exception()}
          | {:error, internal_service_exception()}
          | {:error, invalid_next_token_exception()}
          | {:error, validation_exception()}
