...
defmodule AWS.Firehose do
  ...
  """
  @type update_destination_output() :: %{String.t() => any()}
  ...
  """
  @type start_delivery_stream_encryption_output() :: %{String.t() => any()}
  ...
  """
  @type tag_delivery_stream_output() :: %{String.t() => any()}
  ...
  """
  @type delete_delivery_stream_output() :: %{String.t() => any()}
  ...
  """
  @type stop_delivery_stream_encryption_output() :: %{String.t() => any()}
  ...
  """
  @type untag_delivery_stream_output() :: %{String.t() => any()}
  ...
  @spec create_delivery_stream(map(), create_delivery_stream_input(), list()) ::
          ...
          | {:error, invalid_kms_resource_exception()}
