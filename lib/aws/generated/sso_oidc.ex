...
defmodule AWS.SSOOIDC do
  ...
  @spec create_token(map(), create_token_request(), list()) ::
          ...
          | {:error, authorization_pending_exception()}
          | {:error, expired_token_exception()}
          | {:error, internal_server_exception()}
          | {:error, invalid_client_exception()}
          | {:error, invalid_grant_exception()}
          | {:error, invalid_request_exception()}
          | {:error, invalid_scope_exception()}
          | {:error, slow_down_exception()}
          | {:error, unauthorized_client_exception()}
          | {:error, unsupported_grant_type_exception()}
  ...
  @spec create_token_with_iam(map(), create_token_with_iam_request(), list()) ::
          ...
          | {:error, invalid_grant_exception()}
          | {:error, invalid_request_exception()}
          | {:error, invalid_request_region_exception()}
          | {:error, invalid_scope_exception()}
          | {:error, slow_down_exception()}
          | {:error, unauthorized_client_exception()}
          | {:error, unsupported_grant_type_exception()}
  ...
  @spec register_client(map(), register_client_request(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, internal_server_exception()}
          | {:error, invalid_client_metadata_exception()}
          | {:error, invalid_request_exception()}
          | {:error, invalid_scope_exception()}
