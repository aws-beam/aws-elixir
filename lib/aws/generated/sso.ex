...
defmodule AWS.SSO do
  ...
  Users can get Amazon Web Services account applications and roles assigned to
  them and get federated into the application.
  ...
  Amazon Web Services SSO and other Amazon Web Services services. For more
  ...
  These Amazon Web Services accounts are assigned by the administrator of the
  account. For more information, see [Assign User Access](https://docs.aws.amazon.com/singlesignon/latest/userguide/useraccess.html#assignusers)
  ...
  If a user uses Amazon Web Services SSO to access the AWS CLI, the user’s Amazon
  Web Services SSO sign in session is used to obtain an IAM session, as specified
  in the corresponding Amazon Web Services SSO permission set. More specifically,
  ...
  Amazon Web Services SSO permission sets continue based on the duration
  configured in the permission set. For more information, see [User authentications](https://docs.aws.amazon.com/singlesignon/latest/userguide/authconcept.html)
