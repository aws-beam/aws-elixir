...
defmodule AWS.Deadline do
  ...
  def associate_member_to_farm(%Client{} = client, principal_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def assume_fleet_role_for_read(%Client{} = client, fleet_id, farm_id, options \\ []) do
    url_path =
  ...
  def assume_queue_role_for_read(%Client{} = client, queue_id, farm_id, options \\ []) do
    url_path =
  ...
  def assume_queue_role_for_user(%Client{} = client, queue_id, farm_id, options \\ []) do
    url_path =
  ...
  def batch_get_job_entity(%Client{} = client, worker_id, fleet_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def copy_job_template(%Client{} = client, queue_id, job_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def create_job(%Client{} = client, queue_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def create_queue_environment(%Client{} = client, queue_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def create_worker(%Client{} = client, fleet_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def delete_budget(%Client{} = client, farm_id, budget_id, input, options \\ []) do
    url_path =
  ...
  def delete_fleet(%Client{} = client, fleet_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def delete_limit(%Client{} = client, limit_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def delete_queue(%Client{} = client, queue_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def delete_volume(%Client{} = client, volume_id, fleet_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def delete_worker(%Client{} = client, worker_id, fleet_id, farm_id, input, options \\ []) do
    url_path =
  ...
  def get_budget(%Client{} = client, farm_id, budget_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/budgets/#{AWS.Util.encode_uri(budget_id)}"
  ...
  def get_fleet(%Client{} = client, fleet_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/fleets/#{AWS.Util.encode_uri(fleet_id)}"
  ...
  def get_job(%Client{} = client, queue_id, job_id, farm_id, options \\ []) do
    url_path =
  ...
  def get_limit(%Client{} = client, limit_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/limits/#{AWS.Util.encode_uri(limit_id)}"
  ...
  def get_queue(%Client{} = client, queue_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/queues/#{AWS.Util.encode_uri(queue_id)}"
  ...
  def get_queue_fleet_association(%Client{} = client, queue_id, fleet_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/queue-fleet-associations/#{AWS.Util.encode_uri(queue_id)}/#{AWS.Util.encode_uri(fleet_id)}"
  ...
  def get_queue_limit_association(%Client{} = client, queue_id, limit_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/queue-limit-associations/#{AWS.Util.encode_uri(queue_id)}/#{AWS.Util.encode_uri(limit_id)}"
  ...
  def get_session(%Client{} = client, session_id, queue_id, job_id, farm_id, options \\ []) do
    url_path =
  ...
  def get_step(%Client{} = client, step_id, queue_id, job_id, farm_id, options \\ []) do
    url_path =
  ...
  def get_storage_profile(%Client{} = client, storage_profile_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/storage-profiles/#{AWS.Util.encode_uri(storage_profile_id)}"
  ...
  def get_task(%Client{} = client, task_id, step_id, queue_id, job_id, farm_id, options \\ []) do
    url_path =
  ...
  def get_volume(%Client{} = client, volume_id, fleet_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/fleets/#{AWS.Util.encode_uri(fleet_id)}/volumes/#{AWS.Util.encode_uri(volume_id)}"
  ...
  def get_worker(%Client{} = client, worker_id, fleet_id, farm_id, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/fleets/#{AWS.Util.encode_uri(fleet_id)}/workers/#{AWS.Util.encode_uri(worker_id)}"
  ...
  def list_monitors(%Client{} = client, next_token \\ nil, max_results \\ nil, options \\ []) do
    url_path = "/2023-10-12/monitors"
    headers = []
    query_params = []
  ...
  def update_budget(%Client{} = client, farm_id, budget_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/budgets/#{AWS.Util.encode_uri(budget_id)}"
  ...
  def update_fleet(%Client{} = client, fleet_id, farm_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/fleets/#{AWS.Util.encode_uri(fleet_id)}"
  ...
  def update_job(%Client{} = client, queue_id, job_id, farm_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/queues/#{AWS.Util.encode_uri(queue_id)}/jobs/#{AWS.Util.encode_uri(job_id)}"
  ...
  def update_limit(%Client{} = client, limit_id, farm_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/limits/#{AWS.Util.encode_uri(limit_id)}"
  ...
  def update_queue(%Client{} = client, queue_id, farm_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/queues/#{AWS.Util.encode_uri(queue_id)}"
  ...
  def update_step(%Client{} = client, step_id, queue_id, job_id, farm_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/queues/#{AWS.Util.encode_uri(queue_id)}/jobs/#{AWS.Util.encode_uri(job_id)}/steps/#{AWS.Util.encode_uri(step_id)}"
  ...
  def update_worker(%Client{} = client, worker_id, fleet_id, farm_id, input, options \\ []) do
    url_path =
      "/2023-10-12/farms/#{AWS.Util.encode_uri(farm_id)}/fleets/#{AWS.Util.encode_uri(fleet_id)}/workers/#{AWS.Util.encode_uri(worker_id)}"
