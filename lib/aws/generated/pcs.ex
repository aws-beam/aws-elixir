...
defmodule AWS.PCS do
  ...
  scientific and engineering models on Amazon Web Services using Slurm.

  For more information, see the [Parallel Computing Service User Guide](https://docs.aws.amazon.com/pcs/latest/userguide).
  ...
  The API actions operate on PCS resources. A *resource* is an entity in Amazon
  Web Services that you can work with. Amazon Web Services services create
  resources when you use the features of the service. Examples of PCS resources
  include clusters, compute node groups, and queues. For more information about
  resources in Amazon Web Services, see
  ...
  """
  @type node_lifecycle_script() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type node_lifecycle_actions_request() :: %{(String.t() | atom()) => any()}
  ...
  """
  @type update_node_lifecycle_actions_request() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      script_source() :: %{
        ...
        "s3VersionId" => [String.t() | atom()],
        "scriptLocation" => [String.t() | atom()]
      }
      
  """
  @type script_source() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      register_compute_node_group_instance_response() :: %{
        ...
        "computeNodeGroupId" => [String.t() | atom()],
        "computeNodeGroupName" => [String.t() | atom()],
  ...
  """
  @type node_lifecycle_stages() :: %{(String.t() | atom()) => any()}
  ...
  ## Example:
      ...
      update_compute_node_group_request() :: %{
        ...
        optional("nodeLifecycleActions") => update_node_lifecycle_actions_request(),
  ...
  ## Example:
      ...
      create_compute_node_group_request() :: %{
        ...
        optional("nodeLifecycleActions") => node_lifecycle_actions_request(),
        optional("purchaseOption") => list(any()),
  ...
  """
  @type node_lifecycle_actions() :: %{(String.t() | atom()) => any()}
  ...
  PCS creates the cluster controller in a service-owned account. The cluster
  controller communicates with the cluster resources in your account. The subnets
  and security groups for the cluster must already exist before you use this API
  action.
  ...
  You associate a compute node group with a cluster through 1 or more PCS queues
  or as part of the login fleet. A compute node group includes the definition of
  the compute properties and lifecycle management. PCS uses the information you
  provide to this API action to launch compute nodes in your account. You can only
  specify subnets in the same Amazon VPC as your cluster. You receive billing
  ...
  You can update the scheduler version, modify scheduler settings, and update
  accounting configuration for an existing cluster. For more information about
  updating the scheduler version, see [Updating the scheduler version on a cluster](https://docs.aws.amazon.com/pcs/latest/userguide/working-with_clusters_version_update.html)
