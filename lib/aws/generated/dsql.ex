...
defmodule AWS.DSQL do
  ...
  `multiRegionProperties.clusters`, you need this permission for each current peer
  cluster that your list omits.
  ...
  Region.
     ...
     When you list peer clusters in `multiRegionProperties.clusters`,
  you need `dsql:AddPeerCluster` for every peer cluster in your request. You need
