...
defmodule AWS.SimSpaceWeaver do
  ...
  *.
  ...
  """
  @type stop_clock_output() :: %{String.t() => any()}
  ...
  """
  @type delete_simulation_output() :: %{String.t() => any()}
  ...
  """
  @type stop_app_output() :: %{String.t() => any()}
  ...
  """
  @type delete_app_output() :: %{String.t() => any()}
  ...
  """
  @type stop_simulation_output() :: %{String.t() => any()}
  ...
  """
  @type start_clock_output() :: %{String.t() => any()}
