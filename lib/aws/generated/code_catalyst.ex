...
defmodule AWS.CodeCatalyst do
  ...
  @spec create_dev_environment(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def create_dev_environment(%Client{} = client, space_name, project_name, input, options \\ []) do
    url_path =
  ...
  @spec delete_project(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def delete_project(%Client{} = client, space_name, name, input, options \\ []) do
    url_path =
  ...
  @spec get_dev_environment(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_dev_environment(%Client{} = client, space_name, project_name, id, options \\ []) do
    url_path =
      "/v1/spaces/#{AWS.Util.encode_uri(space_name)}/projects/#{AWS.Util.encode_uri(project_name)}/devEnvironments/#{AWS.Util.encode_uri(id)}"
  ...
  @spec get_project(map(), String.t() | atom(), String.t() | atom(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_project(%Client{} = client, space_name, name, options \\ []) do
    url_path =
      "/v1/spaces/#{AWS.Util.encode_uri(space_name)}/projects/#{AWS.Util.encode_uri(name)}"
  ...
  @spec get_source_repository(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_source_repository(%Client{} = client, space_name, project_name, name, options \\ []) do
    url_path =
      "/v1/spaces/#{AWS.Util.encode_uri(space_name)}/projects/#{AWS.Util.encode_uri(project_name)}/sourceRepositories/#{AWS.Util.encode_uri(name)}"
  ...
  @spec get_user_details(map(), String.t() | atom() | nil, String.t() | atom() | nil, list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_user_details(%Client{} = client, user_name \\ nil, id \\ nil, options \\ []) do
  ...
  @spec get_workflow(map(), String.t() | atom(), String.t() | atom(), String.t() | atom(), list()) ::
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_workflow(%Client{} = client, space_name, project_name, id, options \\ []) do
    url_path =
  ...
  @spec get_workflow_run(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def get_workflow_run(%Client{} = client, space_name, project_name, id, options \\ []) do
    url_path =
  ...
  @spec list_source_repositories(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def list_source_repositories(%Client{} = client, space_name, project_name, input, options \\ []) do
    url_path =
  ...
  @spec list_workflow_runs(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def list_workflow_runs(%Client{} = client, space_name, project_name, input, options \\ []) do
    url_path =
  ...
  @spec list_workflows(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def list_workflows(%Client{} = client, space_name, project_name, input, options \\ []) do
    url_path =
  ...
  @spec start_workflow_run(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def start_workflow_run(%Client{} = client, space_name, project_name, input, options \\ []) do
    url_path =
      "/v1/spaces/#{AWS.Util.encode_uri(space_name)}/projects/#{AWS.Util.encode_uri(project_name)}/workflowRuns"
  ...
  @spec stop_dev_environment(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def stop_dev_environment(%Client{} = client, space_name, project_name, id, input, options \\ []) do
    url_path =
  ...
  @spec update_project(
          ...
          | {:error, {:unexpected_response, any()}}
          | {:error, term()}
  def update_project(%Client{} = client, space_name, name, input, options \\ []) do
    url_path =
      "/v1/spaces/#{AWS.Util.encode_uri(space_name)}/projects/#{AWS.Util.encode_uri(name)}"
