...
defmodule AWS.WAFV2 do
  ...
  """
  @type pre_parse_text_transformation() :: %{(String.t() | atom()) => any()}
  ...
  pool, App Runner service, Amplify application, Amazon Web Services Verified
  Access instance, and Amazon Bedrock AgentCore Gateway.
  """
