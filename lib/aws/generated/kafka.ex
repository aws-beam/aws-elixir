...
defmodule AWS.Kafka do
  ...
  """
  @type describe_cluster_v2_request() :: %{String.t() => any()}
  ...
  """
  @type delete_cluster_policy_response() :: %{String.t() => any()}
  ...
  """
  @type describe_replicator_request() :: %{String.t() => any()}
  ...
  """
  @type delete_configuration_request() :: %{String.t() => any()}
  ...
  """
  @type get_cluster_policy_request() :: %{String.t() => any()}
  ...
  """
  @type describe_configuration_revision_request() :: %{String.t() => any()}
  ...
  """
  @type delete_cluster_policy_request() :: %{String.t() => any()}
  ...
  """
  @type describe_cluster_operation_request() :: %{String.t() => any()}
  ...
  """
  @type describe_configuration_request() :: %{String.t() => any()}
  ...
  """
  @type get_bootstrap_brokers_request() :: %{String.t() => any()}
  ...
  """
  @type describe_cluster_operation_v2_request() :: %{String.t() => any()}
  ...
  """
  @type reject_client_vpc_connection_response() :: %{String.t() => any()}
