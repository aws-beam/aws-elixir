...
defmodule AWS.GroundStation do
  ...
  """
  @type get_satellite_request() :: %{String.t() => any()}
  ...
  """
  @type cancel_contact_request() :: %{String.t() => any()}
  ...
  """
  @type delete_config_request() :: %{String.t() => any()}
  ...
  """
  @type get_mission_profile_request() :: %{String.t() => any()}
  ...
  """
  @type delete_ephemeris_request() :: %{String.t() => any()}
  ...
  """
  @type delete_mission_profile_request() :: %{String.t() => any()}
  ...
  """
  @type delete_dataflow_endpoint_group_request() :: %{String.t() => any()}
  ...
  """
  @type describe_ephemeris_request() :: %{String.t() => any()}
  ...
  """
  @type get_dataflow_endpoint_group_request() :: %{String.t() => any()}
  ...
  """
  @type get_agent_configuration_request() :: %{String.t() => any()}
